...
public class OWLSubDataPropertyOfTest
{
    ...
    public void ShouldDeserializeMultipleAndNestedDataAssertionsViaOntology()
    {
        ...
        Assert.IsTrue(ontology.DataPropertyAxioms.Any(annAxm => annAxm is OWLSubDataPropertyOf subannProp
                                                                && string.Equals(subannProp.SubDataProperty.IRI, "http://purl.org/dc/terms/creator")
    ...
    public void ShouldSerializeToFunctional()
    {
        ...
        OWLSubDataPropertyOf axiom = new OWLSubDataPropertyOf(hasCalories, hasWeight);

        string functionalString = axiom.ToFunctionalString(CreateContext());

        Assert.AreEqual("SubDataPropertyOf( pz:hasCalories pz:hasWeight )", functionalString);
    }
    ...
    public void ShouldSerializeToManchester()
    {
        ...
        Assert.AreEqual("pz:hasWeight", frameItem.ItemText);
    }
    #endregion

...
public class OWLTransitiveObjectPropertyTest
{
    ...
    public void ShouldSerializeToFunctional()
    {
        ...
        OWLTransitiveObjectProperty axiom = new OWLTransitiveObjectProperty(hasTopping);

        string functionalString = axiom.ToFunctionalString(CreateContext());

        Assert.AreEqual("TransitiveObjectProperty( pz:hasTopping )", functionalString);
    }
    ...
    public void ShouldSerializeToManchester()
    {
        ...
        Assert.AreEqual("Transitive", frameItem.ItemText);
    }
    #endregion

...
public class OWLSymmetricObjectPropertyTest
{
    ...
    public void ShouldSerializeToFunctional()
    {
        ...
        OWLSymmetricObjectProperty axiom = new OWLSymmetricObjectProperty(hasTopping);

        string functionalString = axiom.ToFunctionalString(CreateContext());

        Assert.AreEqual("SymmetricObjectProperty( pz:hasTopping )", functionalString);
    }
    ...
    public void ShouldSerializeToManchester()
    {
        ...
        Assert.AreEqual("Symmetric", frameItem.ItemText);
    }
    #endregion

...
public class OWLInverseFunctionalObjectPropertyTest
{
    ...
    public void ShouldSerializeToFunctional()
    {
        ...
        OWLInverseFunctionalObjectProperty axiom = new OWLInverseFunctionalObjectProperty(hasTopping);

        string functionalString = axiom.ToFunctionalString(CreateContext());

        Assert.AreEqual("InverseFunctionalObjectProperty( pz:hasTopping )", functionalString);
    }
    ...
    public void ShouldSerializeToManchester()
    {
        ...
        Assert.AreEqual("InverseFunctional", frameItem.ItemText);
    }
    #endregion

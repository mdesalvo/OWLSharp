...
public class OWLFunctionalObjectPropertyTest
{
    ...
    public void ShouldSerializeToFunctional()
    {
        ...
        OWLFunctionalObjectProperty axiom = new OWLFunctionalObjectProperty(hasTopping);

        string functionalString = axiom.ToFunctionalString(CreateContext());

        Assert.AreEqual("FunctionalObjectProperty( pz:hasTopping )", functionalString);
    }
    ...
    public void ShouldSerializeToManchester()
    {
        ...
        Assert.AreEqual("Functional", frameItem.ItemText);
    }
    #endregion

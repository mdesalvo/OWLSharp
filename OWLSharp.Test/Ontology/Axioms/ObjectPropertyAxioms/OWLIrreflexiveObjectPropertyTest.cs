...
public class OWLIrreflexiveObjectPropertyTest
{
    ...
    public void ShouldSerializeToFunctional()
    {
        ...
        OWLIrreflexiveObjectProperty axiom = new OWLIrreflexiveObjectProperty(hasTopping);

        string functionalString = axiom.ToFunctionalString(CreateContext());

        Assert.AreEqual("IrreflexiveObjectProperty( pz:hasTopping )", functionalString);
    }
    ...
    public void ShouldSerializeToManchester()
    {
        ...
        Assert.AreEqual("Irreflexive", frameItem.ItemText);
    }
    #endregion

...
public class OWLObjectPropertyDomainTest
{
    ...
    {
        OWLObjectPropertyDomain objectPropertyDomain = OWLSerializer.DeserializeObject<OWLObjectPropertyDomain>(
            """
    ...
    public void ShouldConvertObjectPropertyDomainToGraph()
    {
        ...
        Assert.AreEqual(1, graph[RDFVocabulary.FOAF.KNOWS, RDFVocabulary.RDFS.DOMAIN, RDFVocabulary.FOAF.PERSON, null].TriplesCount);
    ...
    public void ShouldSerializeToFunctional()
    {
        ...
        OWLObjectPropertyDomain axiom = new OWLObjectPropertyDomain(hasTopping, pizza);

        string functionalString = axiom.ToFunctionalString(CreateContext());

        Assert.AreEqual("ObjectPropertyDomain( pz:hasTopping pz:Pizza )", functionalString);
    }

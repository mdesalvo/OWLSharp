...
namespace OWLSharp.Test.Ontology.Rules
{
    ...
    public class SWRLSubstringBeforeBuiltInTest
    {
        ...
        public void ShouldCreateSubstringBeforeBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.SubstringBefore(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.SubstringBefore(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

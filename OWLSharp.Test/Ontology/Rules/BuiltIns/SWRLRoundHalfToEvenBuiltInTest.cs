...
public class SWRLRoundHalfToEvenBuiltInTest
{
    ...
    public void ShouldEvaluateRoundHalfToEvenBuiltIn()
    {
        ...
        antecedentResults.AddRow(new string[] { "8^^http://www.w3.org/2001/XMLSchema#int", "7.5^^http://www.w3.org/2001/XMLSchema#double" });
        ...
        Assert.IsTrue(string.Equals((builtinResults.Rows[0]["?Y"] ?? string.Empty), "7.5^^http://www.w3.org/2001/XMLSchema#double"));
    ...
    public void ShouldEvaluateRoundHalfToEvenBuiltInWithLeftNumber()
    {
        OWLTable antecedentResults = new OWLTable();
        antecedentResults.AddColumn("?Y");
        antecedentResults.AddRow(new string[] { "7.5^^http://www.w3.org/2001/XMLSchema#float" });
        ...
        Assert.HasCount(1, builtinResults.Rows);
        Assert.IsTrue(string.Equals((builtinResults.Rows[0]["?Y"] ?? string.Empty), "7.5^^http://www.w3.org/2001/XMLSchema#float"));
    }
    ...
    public void ShouldEvaluateRoundHalfToEvenBuiltInWithRightNumber()
    {
        ...
        antecedentResults.AddRow(new string[] { "8^^http://www.w3.org/2001/XMLSchema#int" });
        antecedentResults.AddRow(new string[] { "7^^http://www.w3.org/2001/XMLSchema#int" });
        antecedentResults.AddRow(new string[] { "2.0^^http://www.w3.org/2001/XMLSchema#float" });
        antecedentResults.AddRow(new string[] { null });
        antecedentResults.AddRow(new string[] { "hello^^http://www.w3.org/2001/XMLSchema#string" });

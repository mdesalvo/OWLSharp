...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLCeilingBuiltInTest
    {
        ...
        public void ShouldCreateCeilingBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Ceiling(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Ceiling(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }
...
@"<BuiltInAtom IRI=""http://www.w3.org/2003/11/swrlb#ceiling""><Variable IRI=""urn:swrl:var#X"" /><Literal datatypeIRI=""http://www.w3.org/2001/XMLSchema#integer"">5</Literal></BuiltInAtom>");
        ...
        public void ShouldEvaluateCeilingBuiltIn()
        {
            ...
            Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?Y"].ToString(), "2.73^^http://www.w3.org/2001/XMLSchema#double"));
        ...
        public void ShouldEvaluateCeilingBuiltInWithLeftNumber()
        {
            ...
            Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?Y"].ToString(), "2.18^^http://www.w3.org/2001/XMLSchema#double"));
            Assert.IsTrue(string.Equals(builtinResults.Rows[1]["?Y"].ToString(), "2.73^^http://www.w3.org/2001/XMLSchema#double"));
        }

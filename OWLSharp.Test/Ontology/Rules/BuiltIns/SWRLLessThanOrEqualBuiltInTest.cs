...
public class SWRLLessThanOrEqualBuiltInTest
{
    ...
    public void ShouldCreateLessThanOrEqualBuiltIn()
    {
        ...
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.LessThanOrEqual(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.LessThanOrEqual(new SWRLVariableArgument(new RDFVariable("?X")), null));
    }
    ...
    public void ShouldEvaluateLessThanOrEqualBuiltIn()
    {
        ...
        antecedentResults.AddRow(new string[] { "2^^http://www.w3.org/2001/XMLSchema#int", "5^^http://www.w3.org/2001/XMLSchema#int" });
        antecedentResults.AddRow(new string[] { "-2^^http://www.w3.org/2001/XMLSchema#int", "-8^^http://www.w3.org/2001/XMLSchema#int" });
        ...
        Assert.IsTrue(string.Equals((builtinResults.Rows[0]["?Y"] ?? string.Empty), "5^^http://www.w3.org/2001/XMLSchema#int"));
        ...
        Assert.IsTrue(string.Equals((builtinResults.Rows[3]["?Y"] ?? string.Empty), "hello@EN-US"));
        Assert.IsTrue(string.Equals((builtinResults.Rows[4]["?X"] ?? string.Empty), "http://example.org/idv1"));
        Assert.IsTrue(string.Equals((builtinResults.Rows[4]["?Y"] ?? string.Empty), "http://example.org/idv2"));
    ...
    public void ShouldEvaluateLessThanOrEqualBuiltInWithLeftLiteral()
    {
        ...
        Assert.IsTrue(string.Equals((builtinResults.Rows[1]["?Y"] ?? string.Empty), "7^^http://www.w3.org/2001/XMLSchema#int"));
        Assert.IsTrue(string.Equals((builtinResults.Rows[2]["?Y"] ?? string.Empty), "2.0^^http://www.w3.org/2001/XMLSchema#float"));
    }
    ...
    public void ShouldEvaluateLessThanOrEqualBuiltInWithRightResource()
    {
        ...
        Assert.HasCount(1, builtinResults.Columns);
        Assert.HasCount(5, builtinResults.Rows);
        Assert.IsTrue(string.Equals((builtinResults.Rows[0]["?X"] ?? string.Empty), ""));
        Assert.IsTrue(string.Equals((builtinResults.Rows[1]["?X"] ?? string.Empty), "hello^^http://www.w3.org/2001/XMLSchema#string"));
        Assert.IsTrue(string.Equals((builtinResults.Rows[2]["?X"] ?? string.Empty), "hello"));
        Assert.IsTrue(string.Equals((builtinResults.Rows[3]["?X"] ?? string.Empty), "hello@EN"));
        Assert.IsTrue(string.Equals((builtinResults.Rows[4]["?X"] ?? string.Empty), "http://example.org/test1"));
    }
    ...
    public void ShouldEvaluateLessThanOrEqualBuiltInWithRightLiteral()
    {
        ...
        Assert.IsTrue(string.Equals((builtinResults.Rows[2]["?X"] ?? string.Empty), "2.0^^http://www.w3.org/2001/XMLSchema#float"));
    }
    #endregion
}

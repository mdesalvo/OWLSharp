...
public class SWRLLessThanOrEqualBuiltInTest
{
    ...
    public void ShouldEvaluateLessThanOrEqualBuiltIn()
    {
        ...
        antecedentResults.AddRow(["2^^http://www.w3.org/2001/XMLSchema#int", "5^^http://www.w3.org/2001/XMLSchema#int"]);
        antecedentResults.AddRow(["-2^^http://www.w3.org/2001/XMLSchema#int", "-8^^http://www.w3.org/2001/XMLSchema#int"
        ]);

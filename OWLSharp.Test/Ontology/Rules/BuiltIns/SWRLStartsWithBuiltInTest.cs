...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLStartsWithBuiltInTest
    {
        ...
        public void ShouldCreateStartsWithBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.StartsWith(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.StartsWith(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

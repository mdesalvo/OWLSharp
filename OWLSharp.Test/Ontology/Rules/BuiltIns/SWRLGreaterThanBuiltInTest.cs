...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLGreaterThanBuiltInTest
    {
        ...
        public void ShouldCreateGreaterThanBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.GreaterThan(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.GreaterThan(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

...
public class SWRLDivideBuiltInTest
{
    ...
    public void ShouldCreateDivideBuiltIn()
    {
        ...
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Divide(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Divide(new SWRLVariableArgument(new RDFVariable("?X")), null));
    }
    ...
    public void ShouldEvaluateDivideBuiltIn()
    {
        ...
        antecedentResults.AddRow(new string[] { "4^^http://www.w3.org/2001/XMLSchema#int", "8^^http://www.w3.org/2001/XMLSchema#int", "2.0^^http://www.w3.org/2001/XMLSchema#float" });

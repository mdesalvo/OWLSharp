...
namespace OWLSharp.Test.Ontology.Rules
{
    ...
    public class SWRLDivideBuiltInTest
    {
        ...
        public void ShouldCreateDivideBuiltIn()
        {
            ...
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Divide(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Divide(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

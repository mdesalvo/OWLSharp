...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLContainsIgnoreCaseBuiltInTest
    {
        ...
        public void ShouldCreateContainsIgnoreCaseBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.ContainsIgnoreCase(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.ContainsIgnoreCase(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

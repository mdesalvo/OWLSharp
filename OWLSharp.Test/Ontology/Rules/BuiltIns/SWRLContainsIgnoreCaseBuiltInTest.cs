...
public class SWRLContainsIgnoreCaseBuiltInTest
{
    ...
    public void ShouldEvaluateContainsIgnoreCaseBuiltIn()
    {
        ...
        antecedentResults.AddRow(["http://example.org/test/", "http://example.org/"]);
    ...
    public void ShouldEvaluateContainsIgnoreCaseBuiltInWithLeftString()
    {
        ...
        Assert.HasCount(6, builtinResults.Rows);
        Assert.IsTrue(string.Equals((builtinResults.Rows[0]["?Y"] ?? string.Empty), "eLlo"));
        Assert.IsTrue(string.Equals((builtinResults.Rows[1]["?Y"] ?? string.Empty), ""));
        Assert.IsTrue(string.Equals((builtinResults.Rows[2]["?Y"] ?? string.Empty), "hello^^http://www.w3.org/2001/XMLSchema#string"));
        ...
        Assert.IsTrue(string.Equals((builtinResults.Rows[5]["?Y"] ?? string.Empty), "hello@EN"));
    }
    ...
    public void ShouldEvaluateContainsIgnoreCaseBuiltInWithRightString()
    {
        ...
        Assert.IsTrue(string.Equals((builtinResults.Rows[4]["?X"] ?? string.Empty), "http://example.org/hello"));
    }

    [TestMethod]
    public void ShouldEvaluateContainsIgnoreCaseBuiltInWithIndividualArguments()
    {
        OWLTable antecedentResults = new OWLTable();

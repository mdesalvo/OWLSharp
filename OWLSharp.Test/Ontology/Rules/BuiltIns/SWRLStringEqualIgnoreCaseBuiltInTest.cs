...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLStringEqualIgnoreCaseBuiltInTest
    {
        ...
        public void ShouldCreateStringEqualIgnoreCaseBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.StringEqualIgnoreCase(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.StringEqualIgnoreCase(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

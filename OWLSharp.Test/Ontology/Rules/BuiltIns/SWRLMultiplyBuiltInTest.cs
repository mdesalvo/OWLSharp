...
namespace OWLSharp.Test.Ontology.Rules
{
    ...
    public class SWRLMultiplyBuiltInTest
    {
        ...
        public void ShouldCreateMultiplyBuiltIn()
        {
            ...
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Multiply(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Multiply(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

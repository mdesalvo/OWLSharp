...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLMultiplyBuiltInTest
    {
        ...
        public void ShouldCreateMultiplyBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Multiply(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Multiply(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

...
public class SWRLMultiplyBuiltInTest
{
    ...
    public void ShouldEvaluateMultiplyBuiltIn()
    {
        ...
        Assert.IsTrue(string.Equals(builtinResults.Rows[1]["?Z"].ToString(), "0.0^^http://www.w3.org/2001/XMLSchema#float"));
    ...
    public void ShouldEvaluateMultiplyBuiltInWithNumbers()
    {
        ...
        Assert.HasCount(1, builtinResults.Rows);
        Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?X"].ToString(), "2^^http://www.w3.org/2001/XMLSchema#int"));
        Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?Y"].ToString(), "1.0^^http://www.w3.org/2001/XMLSchema#float"));
    }
    #endregion
}
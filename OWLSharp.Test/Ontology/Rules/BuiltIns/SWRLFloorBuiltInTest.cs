...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLFloorBuiltInTest
    {
        ...
        public void ShouldCreateFloorBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Floor(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Floor(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

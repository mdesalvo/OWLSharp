...
namespace OWLSharp.Test.Ontology.Rules
{
    ...
    public class SWRLSubstringBuiltInTest
    {
        ...
        public void ShouldCreateSubstringBuiltIn()
        {
            ...
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Substring(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Substring(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

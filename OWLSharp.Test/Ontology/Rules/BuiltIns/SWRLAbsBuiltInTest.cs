...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLAbsBuiltInTest
    {
        ...
        public void ShouldCreateAbsBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Abs(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Abs(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

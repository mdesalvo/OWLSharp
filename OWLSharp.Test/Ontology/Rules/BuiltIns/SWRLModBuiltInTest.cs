...
public class SWRLModBuiltInTest
{
    ...
    public void ShouldCreateModBuiltIn()
    {
        ...
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Mod(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Mod(new SWRLVariableArgument(new RDFVariable("?X")), null));
    }
    ...
    public void ShouldEvaluateModBuiltIn()
    {
        ...
        antecedentResults.AddRow(new string[] { "3^^http://www.w3.org/2001/XMLSchema#int", "13^^http://www.w3.org/2001/XMLSchema#int", "5.0^^http://www.w3.org/2001/XMLSchema#float" });
    ...
    public void ShouldEvaluateModBuiltInWithNumbers()
    {
        ...
        antecedentResults.AddColumn("?X");
        antecedentResults.AddColumn("?Y");
        antecedentResults.AddRow(new string[] { "3^^http://www.w3.org/2001/XMLSchema#int", "13.0^^http://www.w3.org/2001/XMLSchema#float" });
        ...
        Assert.IsTrue(string.Equals((builtinResults.Rows[1]["?X"] ?? string.Empty), "-2^^http://www.w3.org/2001/XMLSchema#int"));

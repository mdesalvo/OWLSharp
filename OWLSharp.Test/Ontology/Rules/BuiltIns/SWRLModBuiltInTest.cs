...
public class SWRLModBuiltInTest
{
    ...
    public void ShouldEvaluateModBuiltIn()
    {
        ...
        antecedentResults.AddRow(["3^^http://www.w3.org/2001/XMLSchema#int", "13^^http://www.w3.org/2001/XMLSchema#int", "5.0^^http://www.w3.org/2001/XMLSchema#float"
        ]);
    ...
    public void ShouldEvaluateModBuiltInWithNumbers()
    {
        ...
        antecedentResults.AddColumn("?X");
        antecedentResults.AddColumn("?Y");
        antecedentResults.AddRow(["3^^http://www.w3.org/2001/XMLSchema#int", "13.0^^http://www.w3.org/2001/XMLSchema#float"
        ]);

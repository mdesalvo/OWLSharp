...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLModBuiltInTest
    {
        ...
        public void ShouldCreateModBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Mod(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Mod(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

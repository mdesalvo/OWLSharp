...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLIntegerDivideBuiltInTest
    {
        ...
        public void ShouldCreateIntegerDivideBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.IntegerDivide(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.IntegerDivide(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }
...
@"<BuiltInAtom IRI=""http://www.w3.org/2003/11/swrlb#integerDivide""><Variable IRI=""urn:swrl:var#X"" /><Literal datatypeIRI=""http://www.w3.org/2001/XMLSchema#integer"">5</Literal><Variable IRI=""urn:swrl:var#Y"" /></BuiltInAtom>");
        ...
        public void ShouldEvaluateIntegerDivideBuiltIn()
        {
            ...
            antecedentResults.Rows.Add("2^^http://www.w3.org/2001/XMLSchema#int", "13^^http://www.w3.org/2001/XMLSchema#int", "5.0^^http://www.w3.org/2001/XMLSchema#float");
        ...
        public void ShouldEvaluateIntegerDivideBuiltInWithNumbers()
        {
            ...
            antecedentResults.Columns.Add("?X");
            antecedentResults.Columns.Add("?Y");
            antecedentResults.Rows.Add("2^^http://www.w3.org/2001/XMLSchema#int", "13.0^^http://www.w3.org/2001/XMLSchema#float");

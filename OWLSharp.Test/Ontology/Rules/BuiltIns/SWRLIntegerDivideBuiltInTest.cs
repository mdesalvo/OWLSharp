...
namespace OWLSharp.Test.Ontology.Rules
{
    ...
    public class SWRLIntegerDivideBuiltInTest
    {
        ...
        public void ShouldCreateIntegerDivideBuiltIn()
        {
            ...
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.IntegerDivide(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.IntegerDivide(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

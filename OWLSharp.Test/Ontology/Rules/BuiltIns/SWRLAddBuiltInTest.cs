...
public class SWRLAddBuiltInTest
{
    ...
    public void ShouldCreateAddBuiltIn()
    {
        ...
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Add(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Add(new SWRLVariableArgument(new RDFVariable("?X")), null));
    }
    ...
    public void ShouldEvaluateAddBuiltIn()
    {
        ...
        antecedentResults.AddRow(new string[] { "2^^http://www.w3.org/2001/XMLSchema#int", "-2^^http://www.w3.org/2001/XMLSchema#int", "4.0^^http://www.w3.org/2001/XMLSchema#float" });

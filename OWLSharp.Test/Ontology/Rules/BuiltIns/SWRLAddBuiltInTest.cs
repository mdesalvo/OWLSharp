...
namespace OWLSharp.Test.Ontology.Rules
{
    ...
    public class SWRLAddBuiltInTest
    {
        ...
        public void ShouldCreateAddBuiltIn()
        {
            ...
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Add(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Add(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

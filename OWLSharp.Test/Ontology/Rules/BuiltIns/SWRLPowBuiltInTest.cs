...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLPowBuiltInTest
    {
        ...
        public void ShouldCreatePowBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Pow(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Pow(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }
...
@"<BuiltInAtom IRI=""http://www.w3.org/2003/11/swrlb#pow""><Variable IRI=""urn:swrl:var#X"" /><Literal datatypeIRI=""http://www.w3.org/2001/XMLSchema#integer"">5</Literal><Variable IRI=""urn:swrl:var#Y"" /></BuiltInAtom>");
        ...
        public void ShouldEvaluatePowBuiltIn()
        {
            ...
            antecedentResults.Rows.Add("8^^http://www.w3.org/2001/XMLSchema#int", "2^^http://www.w3.org/2001/XMLSchema#int", "3.0^^http://www.w3.org/2001/XMLSchema#float");
        ...
        public void ShouldEvaluatePowBuiltInWithNumbers()
        {
            ...
            antecedentResults.Columns.Add("?X");
            antecedentResults.Columns.Add("?Y");
            antecedentResults.Rows.Add("4^^http://www.w3.org/2001/XMLSchema#int", "2.0^^http://www.w3.org/2001/XMLSchema#float");

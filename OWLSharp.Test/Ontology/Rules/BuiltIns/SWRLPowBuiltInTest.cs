...
public class SWRLPowBuiltInTest
{
    ...
    public void ShouldEvaluatePowBuiltIn()
    {
        ...
        antecedentResults.AddRow(["8^^http://www.w3.org/2001/XMLSchema#int", "2^^http://www.w3.org/2001/XMLSchema#int", "3.0^^http://www.w3.org/2001/XMLSchema#float"
        ]);
        antecedentResults.AddRow(["1^^http://www.w3.org/2001/XMLSchema#int", "2^^http://www.w3.org/2001/XMLSchema#int", "0^^http://www.w3.org/2001/XMLSchema#int"
        ]);
    ...
    public void ShouldEvaluatePowBuiltInWithNumbers()
    {
        ...
        antecedentResults.AddColumn("?X");
        antecedentResults.AddColumn("?Y");
        antecedentResults.AddRow(["4^^http://www.w3.org/2001/XMLSchema#int", "2.0^^http://www.w3.org/2001/XMLSchema#float"
        ]);

...
public class SWRLTanBuiltInTest
{
    ...
    public void ShouldCreateTanBuiltIn()
    {
        ...
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Tan(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
        Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Tan(new SWRLVariableArgument(new RDFVariable("?X")), null));
    }

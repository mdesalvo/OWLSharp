...
public class SWRLEqualBuiltInTest
{
    ...
    public void ShouldEvaluateEqualBuiltIn()
    {
        ...
        Assert.IsTrue(string.Equals(builtinResults.Rows[3]["?X"].ToString(), "http://example.org/idv1"));
    ...
    public void ShouldEvaluateEqualBuiltInWithLeftResource()
    {
        ...
        Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?Y"].ToString(), "http://example.org/test"));
    }
    ...
    public void ShouldEvaluateEqualBuiltInWithLeftLiteral()
    {
        ...
        Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?Y"].ToString(), "2^^http://www.w3.org/2001/XMLSchema#int"));
        Assert.IsTrue(string.Equals(builtinResults.Rows[1]["?Y"].ToString(), "2.0^^http://www.w3.org/2001/XMLSchema#float"));
    }

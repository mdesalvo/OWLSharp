...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLStringConcatBuiltInTest
    {
        ...
        public void ShouldCreateStringConcatBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.StringConcat(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.StringConcat(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

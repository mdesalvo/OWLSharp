...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLDateBuiltInTest
    {
        ...
        public void ShouldCreateDateBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Date(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Date(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLNormalizeSpaceBuiltInTest
    {
        ...
        public void ShouldCreateNormalizeSpaceBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.NormalizeSpace(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.NormalizeSpace(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

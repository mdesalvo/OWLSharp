...
namespace OWLSharp.Test.Ontology.Rules
{
    ...
    public class SWRLNormalizeSpaceBuiltInTest
    {
        ...
        public void ShouldCreateNormalizeSpaceBuiltIn()
        {
            ...
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.NormalizeSpace(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.NormalizeSpace(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

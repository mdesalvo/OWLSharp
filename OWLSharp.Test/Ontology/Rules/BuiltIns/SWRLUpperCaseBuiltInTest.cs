...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLUpperCaseBuiltInTest
    {
        ...
        public void ShouldCreateUpperCaseBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.UpperCase(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.UpperCase(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

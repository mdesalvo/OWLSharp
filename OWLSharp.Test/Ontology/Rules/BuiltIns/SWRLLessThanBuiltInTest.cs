...
namespace OWLSharp.Test.Ontology.Rules
{
    ...
    public class SWRLLessThanBuiltInTest
    {
        ...
        public void ShouldCreateLessThanBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.LessThan(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.LessThan(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

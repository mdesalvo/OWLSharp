...
public class SWRLUnaryPlusBuiltInTest
{
    ...
    public void ShouldEvaluateUnaryPlusBuiltIn()
    {
        ...
        Assert.IsTrue(string.Equals(builtinResults.Rows[1]["?Y"].ToString(), "-3^^http://www.w3.org/2001/XMLSchema#negativeInteger"));
    ...
    public void ShouldEvaluateUnaryPlusBuiltInWithLeftNumber()
    {
        ...
        Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?Y"].ToString(), "2.000^^http://www.w3.org/2001/XMLSchema#double"));
    }
    ...
    public void ShouldEvaluateUnaryPlusBuiltInWithRightNumber()
    {
        ...
        Assert.HasCount(1, builtinResults.Columns);
        Assert.HasCount(1, builtinResults.Rows);
        Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?X"].ToString(), "2.7300^^http://www.w3.org/2001/XMLSchema#double"));
    }
    #endregion
}
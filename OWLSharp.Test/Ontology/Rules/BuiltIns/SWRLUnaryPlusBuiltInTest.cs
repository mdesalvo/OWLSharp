...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLUnaryPlusBuiltInTest
    {
        ...
        public void ShouldCreateUnaryPlusBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.UnaryPlus(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.UnaryPlus(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }
...
@"<BuiltInAtom IRI=""http://www.w3.org/2003/11/swrlb#unaryPlus""><Variable IRI=""urn:swrl:var#X"" /><Literal datatypeIRI=""http://www.w3.org/2001/XMLSchema#integer"">5</Literal></BuiltInAtom>");
        ...
        public void ShouldEvaluateUnaryPlusBuiltIn()
        {
            ...
            antecedentResults.Rows.Add("-3^^http://www.w3.org/2001/XMLSchema#int", "-3^^http://www.w3.org/2001/XMLSchema#negativeInteger");
        ...
        public void ShouldEvaluateUnaryPlusBuiltInWithLeftNumber()
        {
            DataTable antecedentResults = new DataTable();
            antecedentResults.Columns.Add("?Y");
            antecedentResults.Rows.Add("2.000^^http://www.w3.org/2001/XMLSchema#double");
        ...
        public void ShouldEvaluateUnaryPlusBuiltInWithRightNumber()
        {
            DataTable antecedentResults = new DataTable();
            antecedentResults.Columns.Add("?X");
            antecedentResults.Rows.Add("2.7300^^http://www.w3.org/2001/XMLSchema#double");

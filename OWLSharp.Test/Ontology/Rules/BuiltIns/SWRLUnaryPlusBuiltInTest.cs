...
public class SWRLUnaryPlusBuiltInTest
{
    ...
    public void ShouldEvaluateUnaryPlusBuiltIn()
    {
        ...
        antecedentResults.AddRow(new string[] { "2^^http://www.w3.org/2001/XMLSchema#int", "2.00^^http://www.w3.org/2001/XMLSchema#double" });
        antecedentResults.AddRow(new string[] { "-3^^http://www.w3.org/2001/XMLSchema#int", "-3^^http://www.w3.org/2001/XMLSchema#negativeInteger" });
    ...
    public void ShouldEvaluateUnaryPlusBuiltInWithLeftNumber()
    {
        OWLTable antecedentResults = new OWLTable();
        antecedentResults.AddColumn("?Y");
        antecedentResults.AddRow(new string[] { "2.000^^http://www.w3.org/2001/XMLSchema#double" });
    ...
    public void ShouldEvaluateUnaryPlusBuiltInWithRightNumber()
    {
        OWLTable antecedentResults = new OWLTable();
        antecedentResults.AddColumn("?X");
        antecedentResults.AddRow(new string[] { "2.7300^^http://www.w3.org/2001/XMLSchema#double" });

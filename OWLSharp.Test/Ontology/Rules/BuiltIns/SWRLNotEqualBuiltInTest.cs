...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLNotEqualBuiltInTest
    {
        ...
        public void ShouldCreateNotEqualBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.NotEqual(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.NotEqual(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }
...
@"<BuiltInAtom IRI=""http://www.w3.org/2003/11/swrlb#notEqual""><Variable IRI=""urn:swrl:var#X"" /><Literal datatypeIRI=""http://www.w3.org/2001/XMLSchema#integer"">5</Literal></BuiltInAtom>");
        ...
        public void ShouldEvaluateNotEqualBuiltIn()
        {
            ...
            Assert.AreEqual(9, builtinResults2.Rows.Count);
            ...
            Assert.AreEqual(9, builtinResults3.Rows.Count);

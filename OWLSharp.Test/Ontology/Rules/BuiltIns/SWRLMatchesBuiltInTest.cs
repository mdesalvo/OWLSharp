...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLMatchesBuiltInTest
    {
        ...
        public void ShouldCreateMatchesBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Matches(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Matches(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLSinBuiltInTest
    {
        ...
        public void ShouldCreateSinBuiltIn()
        {
            ...
            Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Sin(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsExactly<SWRLException>(() => _ = SWRLBuiltIn.Sin(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

...
public class SWRLCosBuiltInTest
{
    ...
    public void ShouldEvaluatecosBuiltIn()
    {
        ...
        Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?Y"].ToString(), "0^^http://www.w3.org/2001/XMLSchema#int"));
    ...
    public void ShouldEvaluatecosBuiltInWithRightNumber()
    {
        ...
        Assert.HasCount(1, builtinResults.Columns);
        Assert.HasCount(1, builtinResults.Rows);
        Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?X"].ToString(), "1.0^^http://www.w3.org/2001/XMLSchema#float"));
    }
    #endregion
}
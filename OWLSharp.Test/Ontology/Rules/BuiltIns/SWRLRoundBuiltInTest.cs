...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLRoundBuiltInTest
    {
        ...
        public void ShouldCreateRoundBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Round(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Round(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }
...
@"<BuiltInAtom IRI=""http://www.w3.org/2003/11/swrlb#round""><Variable IRI=""urn:swrl:var#X"" /><Literal datatypeIRI=""http://www.w3.org/2001/XMLSchema#integer"">5</Literal></BuiltInAtom>");
        ...
        public void ShouldEvaluateRoundBuiltIn()
        {
            ...
            antecedentResults.Rows.Add("2^^http://www.w3.org/2001/XMLSchema#int", "2.44^^http://www.w3.org/2001/XMLSchema#double");
            ...
            Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?Y"].ToString(), "2.44^^http://www.w3.org/2001/XMLSchema#double"));
        ...
        public void ShouldEvaluateRoundBuiltInWithLeftNumber()
        {
            DataTable antecedentResults = new DataTable();
            antecedentResults.Columns.Add("?Y");
            antecedentResults.Rows.Add("2.44^^http://www.w3.org/2001/XMLSchema#float");
            ...
            Assert.IsTrue(string.Equals(builtinResults.Rows[0]["?Y"].ToString(), "2.44^^http://www.w3.org/2001/XMLSchema#float"));

...
namespace OWLSharp.Test.Ontology
{
    ...
    public class SWRLSubtractBuiltInTest
    {
        ...
        public void ShouldCreateSubtractBuiltIn()
        {
            ...
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Subtract(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<SWRLException>(() => SWRLBuiltIn.Subtract(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }

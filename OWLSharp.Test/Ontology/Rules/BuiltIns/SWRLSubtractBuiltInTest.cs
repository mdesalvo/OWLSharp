...
namespace OWLSharp.Test.Ontology.Rules
{
    ...
    public class SWRLSubtractBuiltInTest
    {
        ...
        public void ShouldCreateSubtractBuiltIn()
        {
            ...
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Subtract(null, new SWRLVariableArgument(new RDFVariable("?Y"))));
            Assert.ThrowsException<OWLException>(() => SWRLBuiltIn.Subtract(new SWRLVariableArgument(new RDFVariable("?X")), null));
        }
...
@"<BuiltInAtom IRI=""http://www.w3.org/2003/11/swrlb#subtract""><Variable IRI=""urn:swrl:var#X"" /><Literal datatypeIRI=""http://www.w3.org/2001/XMLSchema#integer"">5</Literal><Variable IRI=""urn:swrl:var#Y"" /></BuiltInAtom>");
        ...
        public void ShouldEvaluateSubtractBuiltIn()
        {
            ...
            antecedentResults.Rows.Add("8^^http://www.w3.org/2001/XMLSchema#int", "12^^http://www.w3.org/2001/XMLSchema#int", "4.0^^http://www.w3.org/2001/XMLSchema#float");
            ...
            antecedentResults.Rows.Add("0^^http://www.w3.org/2001/XMLSchema#int", "2^^http://www.w3.org/2001/XMLSchema#int", "2.0^^http://www.w3.org/2001/XMLSchema#float");
        ...
        [TestMethod]
        public void ShouldEvaluateSubtractBuiltInWithOnly2Arguments()
        {
            DataTable antecedentResults = new DataTable();
            antecedentResults.Columns.Add("?X");
            antecedentResults.Columns.Add("?Y");
        ...
        public void ShouldEvaluateSubtractBuiltInWithNumbers()
        {
            ...
            antecedentResults.Columns.Add("?X");
            antecedentResults.Columns.Add("?Y");
            antecedentResults.Rows.Add("2^^http://www.w3.org/2001/XMLSchema#int", "0.0^^http://www.w3.org/2001/XMLSchema#float");
            antecedentResults.Rows.Add("0^^http://www.w3.org/2001/XMLSchema#int", "-2^^http://www.w3.org/2001/XMLSchema#int");
            antecedentResults.Rows.Add(DBNull.Value, "2^^http://www.w3.org/2001/XMLSchema#int");
            antecedentResults.Rows.Add("2^^http://www.w3.org/2001/XMLSchema#int", DBNull.Value);
            antecedentResults.Rows.Add(DBNull.Value, DBNull.Value);
            antecedentResults.Rows.Add("2^^http://www.w3.org/2001/XMLSchema#int", "hello^^http://www.w3.org/2001/XMLSchema#string");

...
namespace OWLSharp.Test.Ontology
{
    ...
    public class OWLObjectPropertyTest
    {
        ...
        public void ShouldCreateQualifiedNameObjectProperty()
        {
            ...
            Assert.IsTrue(Equals(op.AbbreviatedIRI, new XmlQualifiedName("knows", RDFVocabulary.FOAF.BASE_URI)));
        }
...
"""<ObjectProperty IRI="http://xmlns.com/foaf/0.1/knows" />""");
            ...
            Assert.IsTrue(op.ExpressionIRI.ToString().StartsWith("bnode:ex", StringComparison.Ordinal));
            op.GetIRI();
            Assert.IsFalse(op.ExpressionIRI.ToString().StartsWith("bnode:ex", StringComparison.Ordinal));

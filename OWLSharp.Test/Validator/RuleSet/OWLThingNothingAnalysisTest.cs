...
[TestClass]
public class OWLThingNothingAnalysisTest
{
    #region Tests
    [TestMethod]
    public void ShouldAnalyzeThingNothingT1Case()
    {
        ...
        List<OWLIssue> issues = OWLThingNothingAnalysis.ExecuteRule(ontology);
    ...
    public void ShouldAnalyzeThingNothingN1Case()
    {
        ...
        Assert.IsTrue(issues.TrueForAll(iss => string.Equals(iss.Suggestion, OWLThingNothingAnalysis.rulesuggN1)));
    }
    ...
    public void ShouldAnalyzeThingNothingN2Case()
    {
        ...
        Assert.IsTrue(issues.TrueForAll(iss => string.Equals(iss.Suggestion, OWLThingNothingAnalysis.rulesuggN2)));
    }
    #endregion
}
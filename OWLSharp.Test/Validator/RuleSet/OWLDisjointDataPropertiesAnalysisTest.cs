...
[TestClass]
public class OWLDisjointDataPropertiesAnalysisTest
{
    #region Tests
    [TestMethod]
    public void ShouldAnalyzeDisjointDataProperties()
    {
        ...
        List<OWLIssue> issues = OWLDisjointDataPropertiesAnalysis.ExecuteRule(ontology);
    ...
    public void ShouldAnalyzeDisjointDataPropertiesSubDataPropertyOfCase()
    {
        ...
        Assert.IsTrue(issues.TrueForAll(iss => iss.Severity == OWLEnums.OWLIssueSeverity.Error));
        Assert.IsTrue(issues.TrueForAll(iss => string.Equals(iss.RuleName, OWLDisjointDataPropertiesAnalysis.rulename)));
        Assert.IsTrue(issues.TrueForAll(iss => string.Equals(iss.Suggestion, OWLDisjointDataPropertiesAnalysis.rulesugg2)));
    }

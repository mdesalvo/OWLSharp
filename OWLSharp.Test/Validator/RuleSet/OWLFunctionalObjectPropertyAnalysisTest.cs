...
[TestClass]
public class OWLFunctionalObjectPropertyAnalysisTest
{
    #region Tests
    [TestMethod]
    public void ShouldAnalyzeFunctionalObjectPropertySimpleCase()
    {
        ...
        List<OWLIssue> issues = OWLFunctionalObjectPropertyAnalysis.ExecuteRule(ontology);
    ...
    public void ShouldAnalyzeFunctionalObjectPropertyTransitiveCase()
    {
        ...
        Assert.IsTrue(issues.TrueForAll(iss => iss.Severity == OWLEnums.OWLIssueSeverity.Error));
        Assert.IsTrue(issues.TrueForAll(iss => string.Equals(iss.RuleName, OWLFunctionalObjectPropertyAnalysis.rulename)));
        Assert.IsTrue(issues.TrueForAll(iss => string.Equals(iss.Suggestion, OWLFunctionalObjectPropertyAnalysis.rulesugg2)));
    }

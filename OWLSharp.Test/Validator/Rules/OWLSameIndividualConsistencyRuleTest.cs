...
{
    [TestClass]
    public class OWLSameIndividualConsistencyRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldValidateSameIndividualConsistency()
        {
            ...
            data1.DeclareSameIndividuals(new RDFResource("ex:indiv2"),new RDFResource("ex:indiv1"));
            ...
            OWLValidatorReport validatorReport = OWLSameIndividualConsistencyRule.ExecuteRule(new OWLOntology("ex:org") { Data = data1 });
        ...
        [TestMethod]
        public void ShouldValidateSameIndividualConsistencyViaValidator()
        {
            OWLOntologyData data1 = new OWLOntologyData();
            data1.DeclareIndividual(new RDFResource("ex:indiv1"));
            data1.DeclareIndividual(new RDFResource("ex:indiv2"));
            ...
            data2.DeclareIndividual(new RDFResource("ex:indiv1"));
            data2.DeclareIndividual(new RDFResource("ex:indiv2"));
            data2.DeclareDifferentIndividuals(new RDFResource("ex:indiv1"),new RDFResource("ex:indiv2"));

            data1.Merge(data2);

            OWLValidator validator = new OWLValidator().AddRule(OWLEnums.OWLValidatorRules.SameIndividualConsistency);

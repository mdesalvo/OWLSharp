...
{
    [TestClass]
    public class OWLEquivalentPropertyConsistencyRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldValidateEquivalentPropertyConsistencyFailingOnSubPropertyLeft()
        {
            ...
            propertymodel1.DeclareEquivalentProperties(new RDFResource("ex:objprop1"),new RDFResource("ex:objprop2"));
            ...
            OWLValidatorReport validatorReport = OWLEquivalentPropertyConsistencyRule.ExecuteRule(new OWLOntology("ex:org") { 
        ...
        [TestMethod]
        public void ShouldValidateEquivalentPropertyConsistencyFailingOnSubPropertyRight()
        {
            OWLOntologyPropertyModel propertymodel1 = new OWLOntologyPropertyModel();
            propertymodel1.DeclareObjectProperty(new RDFResource("ex:objprop1"));
            propertymodel1.DeclareObjectProperty(new RDFResource("ex:objprop2"));
        ...
        [TestMethod]
        public void ShouldValidateEquivalentPropertyConsistencyFailingOnDisjointProperty()
        {
            OWLOntologyPropertyModel propertymodel1 = new OWLOntologyPropertyModel();
            propertymodel1.DeclareObjectProperty(new RDFResource("ex:objprop1"));
            propertymodel1.DeclareObjectProperty(new RDFResource("ex:objprop2"));
        ...
        [TestMethod]
        public void ShouldValidateEquivalentPropertyConsistencyFailingOnChainAxiomProperty()
        {
            OWLOntologyPropertyModel propertymodel1 = new OWLOntologyPropertyModel();
            propertymodel1.DeclareObjectProperty(new RDFResource("ex:objprop1"));
            propertymodel1.DeclareObjectProperty(new RDFResource("ex:objprop2"));
            propertymodel1.DeclareEquivalentProperties(new RDFResource("ex:objprop2"), new RDFResource("ex:objprop1"));
            OWLOntologyPropertyModel propertymodel2 = new OWLOntologyPropertyModel();
            propertymodel2.DeclareObjectProperty(new RDFResource("ex:objprop1"));
        ...
        [TestMethod]
        public void ShouldValidateEquivalentPropertyConsistencyViaValidator()
        {
            OWLOntologyPropertyModel propertymodel1 = new OWLOntologyPropertyModel();
            propertymodel1.DeclareObjectProperty(new RDFResource("ex:objprop1"));
            propertymodel1.DeclareObjectProperty(new RDFResource("ex:objprop2"));
            ...
            OWLValidator validator = new OWLValidator().AddRule(OWLEnums.OWLValidatorRules.EquivalentPropertyConsistency);

...
{
    [TestClass]
    public class OWLEquivalentClassConsistencyRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldValidateEquivalentClassConsistencyFailingOnSubClassLeft()
        {
            ...
            classmodel1.DeclareEquivalentClasses(new RDFResource("ex:class1"),new RDFResource("ex:class2"));
            ...
            OWLValidatorReport validatorReport = OWLEquivalentClassConsistencyRule.ExecuteRule(new OWLOntology("ex:org") { 
        ...
        [TestMethod]
        public void ShouldValidateEquivalentClassConsistencyFailingOnSubClassRight()
        {
            OWLOntologyClassModel classmodel1 = new OWLOntologyClassModel();
            classmodel1.DeclareClass(new RDFResource("ex:class1"));
            classmodel1.DeclareClass(new RDFResource("ex:class2"));
        ...
        [TestMethod]
        public void ShouldValidateEquivalentClassConsistencyFailingOnDisjointClass()
        {
            OWLOntologyClassModel classmodel1 = new OWLOntologyClassModel();
            classmodel1.DeclareClass(new RDFResource("ex:class1"));
            classmodel1.DeclareClass(new RDFResource("ex:class2"));
        ...
        [TestMethod]
        public void ShouldValidateEquivalentClassConsistencyViaValidator()
        {
            OWLOntologyClassModel classmodel1 = new OWLOntologyClassModel();
            classmodel1.DeclareClass(new RDFResource("ex:class1"));
            classmodel1.DeclareClass(new RDFResource("ex:class2"));
            ...
            OWLValidator validator = new OWLValidator().AddRule(OWLEnums.OWLValidatorRules.EquivalentClassConsistency);

    ...
    public class OWLValidatorEvidenceTest
    {
        ...
        public void ShouldCreateValidatorEvidence()
        {
            OWLValidatorEvidence evidence = new OWLValidatorEvidence(
                OWLEnums.OWLValidatorEvidenceCategory.Warning, "rulename", "message", "suggestion");

            Assert.IsNotNull(evidence);
            Assert.IsTrue(evidence.EvidenceCategory == OWLEnums.OWLValidatorEvidenceCategory.Warning);

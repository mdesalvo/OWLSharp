...
namespace OWLSharp.Reasoner.Test
{
    ...
    public class OWLInverseOfEntailmentRuleTest
    {
        ...
        [TestMethod]
        public void ShouldExecuteInverseOfEntailmentWithInlineBlankSubProperties()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
        ...
        [TestMethod]
        public void ShouldExecuteInverseOfEntailmentWithInlineBlankEquivalentProperties()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
            ontology.Model.PropertyModel.DeclareObjectProperty(new RDFResource("ex:DescendantOf"));
            ontology.Model.PropertyModel.DeclareObjectProperty(new RDFResource("ex:ParentOf"));

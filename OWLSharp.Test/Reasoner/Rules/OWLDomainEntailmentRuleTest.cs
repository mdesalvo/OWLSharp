...
namespace OWLSharp.Reasoner.Test
{
    ...
    public class OWLDomainEntailmentRuleTest
    {
        ...
        public void ShouldExecuteDomainEntailmentOnObjectProperties()
        {
            ...
            OWLReasonerReport reasonerReport = OWLDomainEntailmentRule.ExecuteRule(ontology);
        ...
        public void ShouldExecuteDomainEntailmentOnObjectPropertiesViaReasoner()
        {
            ...
            OWLReasoner reasoner = new OWLReasoner().AddStandardRule(OWLEnums.OWLReasonerStandardRules.DomainEntailment);

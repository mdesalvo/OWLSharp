...
{
    [TestClass]
    public class OWLSymmetricPropertyEntailmentRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldExecuteSymmetricPropertyEntailment()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
            ontology.Model.PropertyModel.DeclareObjectProperty(new RDFResource("ex:objprop"), new OWLOntologyObjectPropertyBehavior() { Symmetric = true });
        ...
        [TestMethod]
        public void ShouldExecuteSymmetricPropertyEntailmentViaReasoner()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
            ontology.Model.PropertyModel.DeclareObjectProperty(new RDFResource("ex:objprop"), new OWLOntologyObjectPropertyBehavior() { Symmetric = true });
            ontology.Data.DeclareIndividual(new RDFResource("ex:indiv1"));
            ...
            OWLReasoner reasoner = new OWLReasoner().AddStandardRule(OWLEnums.OWLReasonerStandardRules.SymmetricPropertyEntailment);

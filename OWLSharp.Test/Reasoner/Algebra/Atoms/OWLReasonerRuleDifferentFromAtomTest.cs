...
{
    [TestClass]
    public class OWLReasonerRuleDifferentFromAtomTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateDifferentFromAtomWithVariableAsRightArgument()
        {
            OWLReasonerRuleDifferentFromAtom DifferentFromAtom = new OWLReasonerRuleDifferentFromAtom(new RDFVariable("?L"), new RDFVariable("?R"));
        ...
        {
            OWLReasonerRuleDifferentFromAtom DifferentFromAtom = new OWLReasonerRuleDifferentFromAtom(new RDFVariable("?L"), new RDFResource("ex:val"));
        ...
        public void ShouldThrowExceptionOnCreatingDifferentFromAtomBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleDifferentFromAtom(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDifferentFromAtomBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleDifferentFromAtom(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDifferentFromAtomBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleDifferentFromAtom(new RDFVariable("?L"), null as RDFResource));
        ...
        {
            OWLReasonerRuleDifferentFromAtom DifferentFromAtom = new OWLReasonerRuleDifferentFromAtom(new RDFVariable("?L"), new RDFResource("ex:indiv2"));
        ...
        {
            OWLReasonerRuleDifferentFromAtom DifferentFromAtom = new OWLReasonerRuleDifferentFromAtom(new RDFVariable("?L"), new RDFResource("ex:val1"));

...
namespace OWLSharp.Reasoner.Test
{
    ...
    public class OWLReasonerRuleGreaterThanBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingGreaterThanBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleGreaterThanBuiltIn(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGreaterThanBuiltInBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleGreaterThanBuiltIn(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGreaterThanBuiltInBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleGreaterThanBuiltIn(new RDFVariable("?L"), null as RDFResource));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingGreaterThanBuiltInBecauseNullRightArgumentLiteral()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleGreaterThanBuiltIn(new RDFVariable("?L"), null as RDFLiteral));

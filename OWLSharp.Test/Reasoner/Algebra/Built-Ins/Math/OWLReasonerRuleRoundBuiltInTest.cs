...
namespace OWLSharp.Reasoner.Test
{
    ...
    public class OWLReasonerRuleRoundBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingRoundBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleRoundBuiltIn(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingRoundBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleRoundBuiltIn(new RDFVariable("?L"), null));

...
{
    [TestClass]
    public class OWLReasonerRuleDivideBuiltInTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreateDivideBuiltIn()
        {
            OWLReasonerRuleDivideBuiltIn builtin = new OWLReasonerRuleDivideBuiltIn(new RDFVariable("?L"), new RDFVariable("?R"), 2);
        ...
        public void ShouldThrowExceptionOnCreatingDivideBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleDivideBuiltIn(null, new RDFVariable("?R"), 2));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDivideBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleDivideBuiltIn(new RDFVariable("?L"), null, 2));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDivideBuiltInBecauseZeroDivide()
           => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleDivideBuiltIn(new RDFVariable("?L"), new RDFVariable("?R"), 0));
        ...
        public void ShouldEvaluateDivideBuiltIn()
        {
            ...
            OWLReasonerRuleDivideBuiltIn builtin = new OWLReasonerRuleDivideBuiltIn(new RDFVariable("?X"), new RDFVariable("?Y"), 2);

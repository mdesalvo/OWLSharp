...
{
    [TestClass]
    public class OWLReasonerRulePowBuiltInTest
    {
        #region Tests
        [TestMethod]
        public void ShouldCreatePowBuiltIn()
        {
            OWLReasonerRulePowBuiltIn builtin = new OWLReasonerRulePowBuiltIn(new RDFVariable("?L"), new RDFVariable("?R"), 2);
        ...
        public void ShouldThrowExceptionOnCreatingPowBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRulePowBuiltIn(null, new RDFVariable("?R"), 2));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingPowBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRulePowBuiltIn(new RDFVariable("?L"), null, 2));
        ...
        public void ShouldEvaluatePowBuiltIn()
        {
            ...
            OWLReasonerRulePowBuiltIn builtin = new OWLReasonerRulePowBuiltIn(new RDFVariable("?X"), new RDFVariable("?Y"), 2);

...
[TestClass]
public class OWLFactSubDataPropertyOfEntailmentTest
{
    #region Tests
    [TestMethod]
    public void ShouldEntailSubDataPropertyOfAssertionCase()
    {
        ...
        List<OWLInference> inferences = OWLFactSubDataPropertyOfEntailment.ExecuteRule(ontology);

        Assert.IsNotNull(inferences);
        Assert.IsTrue(inferences.TrueForAll(inf => inf.Axiom.IsInference));
        Assert.IsFalse(inferences.Any(i => i.Axiom is OWLSubDataPropertyOf));

...
[TestClass]
public class OWLFactSubObjectPropertyOfEntailmentTest
{
    #region Tests
    [TestMethod]
    public void ShouldEntailSubObjectPropertyOfAssertionCase()
    {
        ...
        List<OWLInference> inferences = OWLFactSubObjectPropertyOfEntailment.ExecuteRule(ontology);

        Assert.IsNotNull(inferences);
        Assert.IsTrue(inferences.TrueForAll(inf => inf.Axiom.IsInference));
        Assert.IsFalse(inferences.Any(i => i.Axiom is OWLSubObjectPropertyOf));
    ...
    [TestMethod]
    public void ShouldEntailSubObjectPropertyOfAssertionWithInverseObjectAssertionCase()
    {
        OWLOntology ontology = new OWLOntology
        {
            DeclarationAxioms = [

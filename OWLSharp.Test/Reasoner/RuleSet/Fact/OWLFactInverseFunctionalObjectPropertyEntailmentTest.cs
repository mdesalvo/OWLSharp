...
[TestClass]
public class OWLFactInverseFunctionalObjectPropertyEntailmentTest
{
    #region Tests
    [TestMethod]
    public void ShouldEntailSimpleObjectPropertiesCase()
    {
        ...
        List<OWLInference> inferences = OWLFactInverseFunctionalObjectPropertyEntailment.ExecuteRule(ontology);

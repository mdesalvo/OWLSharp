...
[TestClass]
public class OWLFactEquivalentObjectPropertiesEntailmentTest
{
    #region Tests
    [TestMethod]
    public void ShouldEntailEquivalentObjectPropertiesAssertionCase()
    {
        ...
        List<OWLInference> inferences = OWLFactEquivalentObjectPropertiesEntailment.ExecuteRule(ontology);

        Assert.IsNotNull(inferences);
        Assert.IsTrue(inferences.TrueForAll(inf => inf.Axiom.IsInference));
        Assert.IsFalse(inferences.Any(i => i.Axiom is OWLEquivalentObjectProperties));
    ...
    [TestMethod]
    public void ShouldEntailEquivalentObjectPropertiesAssertionWithInverseObjectAssertionCase()
    {
        OWLOntology ontology = new OWLOntology
        {
            DeclarationAxioms = [

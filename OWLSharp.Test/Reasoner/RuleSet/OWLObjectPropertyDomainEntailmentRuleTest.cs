...
[TestClass]
public class OWLObjectPropertyDomainEntailmentRuleTest
{
    #region Tests
    [TestMethod]
    public void ShouldEntailSimpleObjectPropertyDomainCase()
    {
        ...
        List<OWLInference> inferences = OWLObjectPropertyDomainEntailmentRule.ExecuteRule(ontology, reasonerContext);

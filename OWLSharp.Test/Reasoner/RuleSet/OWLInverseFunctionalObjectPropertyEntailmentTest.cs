...
[TestClass]
public class OWLInverseFunctionalObjectPropertyEntailmentTest
{
    #region Tests
    [TestMethod]
    public void ShouldEntailSimpleObjectPropertiesCase()
    {
        ...
        List<OWLInference> inferences = OWLInverseFunctionalObjectPropertyEntailment.ExecuteRule(ontology);

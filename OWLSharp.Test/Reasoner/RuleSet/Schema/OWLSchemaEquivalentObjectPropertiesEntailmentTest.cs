...
[TestClass]
public class OWLSchemaEquivalentObjectPropertiesEntailmentTest
{
    #region Tests
    [TestMethod]
    public void ShouldEntailEquivalentObjectPropertiesTransitivityCase()
    {
        ...
        List<OWLInference> inferences = OWLSchemaEquivalentObjectPropertiesEntailment.ExecuteRule(ontology);
    ...
    [TestMethod]
    public void ShouldEntailEquivalentObjectPropertiesTransitivityWithInverseObjectAssertionCase()
    {
        OWLOntology ontology = new OWLOntology
        {
            DeclarationAxioms = [

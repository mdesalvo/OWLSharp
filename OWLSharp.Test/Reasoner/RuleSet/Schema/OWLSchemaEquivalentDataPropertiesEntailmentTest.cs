...
[TestClass]
public class OWLSchemaEquivalentDataPropertiesEntailmentTest
{
    #region Tests
    [TestMethod]
    public void ShouldEntailEquivalentDataPropertiesTransitivityCase()
    {
        ...
        List<OWLInference> inferences = OWLSchemaEquivalentDataPropertiesEntailment.ExecuteRule(ontology);

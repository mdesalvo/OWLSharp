...
[TestClass]
public class OWLSchemaDisjointObjectPropertiesEntailmentTest
{
    #region Tests
    [TestMethod]
    public void ShouldEntailDisjointObjectPropertiesCase()
    {
        ...
        List<OWLInference> inferences = OWLSchemaDisjointObjectPropertiesEntailment.ExecuteRule(ontology);

...
public class GEOHelperTest
{
    ...
    public void ShouldDeclareGEOPointFeatureWithDefaultGeometry()
    {
        ...
        Assert.ThrowsExactly<OWLException>(() => _ = ontology.DeclarePointFeature(new RDFResource("ex:MilanFT"), null));
    }
    ...
    public void ShouldDeclareGEOLineFeatureWithDefaultGeometry()
    {
        ...
        Assert.ThrowsExactly<OWLException>(() => _ = ontology.DeclareLineFeature(new RDFResource("ex:MilanFT"), null));
    }
    ...
    public void ShouldDeclareGEOAreaFeatureWithDefaultGeometry()
    {
        ...
        Assert.ThrowsExactly<OWLException>(() => _ = ontology.DeclareAreaFeature(new RDFResource("ex:MilanFT"), null));
    }
    ...
    public async Task ShouldGetConvexHullOfFeatureAsync()
    {
        ...
        Assert.IsNotNull(milanBuffer);
        Assert.IsTrue(milanBuffer.Equals(new RDFTypedLiteral("POLYGON ((9.19054385 45.46003666, 9.18217536 45.46003666, 9.18217536 45.46819347, 9.19054385 45.46819347, 9.19054385 45.46003666))", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)));
        Assert.IsNotNull(brebemiBuffer);
        Assert.IsTrue(brebemiBuffer.Equals(new RDFTypedLiteral("POLYGON ((9.16778508 45.46481222, 9.6118352 45.68014585, 10.21423284 45.54758259, 9.16778508 45.46481222))", RDFModelEnums.RDFDatatypes.GEOSPARQL_WKT)));

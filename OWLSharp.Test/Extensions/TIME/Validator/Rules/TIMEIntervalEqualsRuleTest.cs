...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEIntervalEqualsRuleTest
    {
        ...
        public void ShouldValidateIntervalEqualsFailingOnBefore()
        {
            ...
            OWLValidatorReport validatorReport = TIMEIntervalEqualsRule.ExecuteRule(ontology, new List<RDFResource>() { new RDFResource("ex:ACenturyINTV"), new RDFResource("ex:BCenturyINTV") });

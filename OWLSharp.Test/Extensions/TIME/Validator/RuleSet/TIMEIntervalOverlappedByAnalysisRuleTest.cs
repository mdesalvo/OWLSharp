...
{
    [TestClass]
    public class TIMEIntervalOverlappedByAnalysisRuleTest : TIMETestOntology
    {
        #region Tests
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule1()
        {
            ...
            List<OWLIssue> issues = await TIMEIntervalOverlappedByAnalysisRule.ExecuteRuleAsync(ontology, cacheRegistry);
            ...
            Assert.IsTrue(string.Equals(issues[0].Suggestion, $"TIME intervals 'ex:IntervalA' and 'ex:IntervalB' should be adjusted to not clash on temporal relations (time:intervalOverlappedBy VS {clashingRelation})"));
        }

        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule2()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule3()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule4()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule5()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule6()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule7()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule8()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule9()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule10()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule11()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule12()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule13()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule14()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),
        ...
        [TestMethod]
        public async Task ShouldAnalyzeIntervalOverlappedByAndViolateRule15()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclarationAxioms.AddRange([
                new OWLDeclaration(new OWLNamedIndividual(new RDFResource("ex:IntervalA"))),

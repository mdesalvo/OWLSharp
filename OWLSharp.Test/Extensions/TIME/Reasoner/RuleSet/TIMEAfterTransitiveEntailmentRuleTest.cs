...
namespace OWLSharp.Test.Extensions.TIME
{
    ...
    public class TIMEAfterTransitiveEntailmentRuleTest : TIMETestOntology
    {
        #region Tests
        [TestMethod]
        public async Task ShouldExecuteAfterTransitiveEntailment()
        {
        ...
        public async Task ShouldExecuteAfterTransitiveEntailmentViaReasoner()
        {
            ...
            TIMEReasoner reasoner = new TIMEReasoner().AddRule(TIMEEnums.TIMEReasonerRules.AfterTransitiveEntailment);

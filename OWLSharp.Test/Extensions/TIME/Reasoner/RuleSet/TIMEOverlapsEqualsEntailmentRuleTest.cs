...
namespace OWLSharp.Test.Extensions.TIME
{
    ...
    public class TIMEOverlapsEqualsEntailmentRuleTest : TIMETestOntology
    {
        #region Tests
        [TestMethod]
        public async Task ShouldExecuteOverlapsEqualsEntailment()
        {
            ...
            List<OWLInference> inferences = await TIMEOverlapsEqualsEntailmentRule.ExecuteRuleAsync(ontology, cacheRegistry);
        ...
        [TestMethod]
        public async Task ShouldExecuteOverlapsEqualsEntailmentViaReasoner()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclareIntervalFeature(new RDFResource("ex:Feature1"), new TIMEInterval(new RDFResource("ex:Interval1")));
            ontology.DeclareIntervalFeature(new RDFResource("ex:Feature2"), new TIMEInterval(new RDFResource("ex:Interval2")));
            ...
            TIMEReasoner reasoner = new TIMEReasoner().AddRule(TIMEEnums.TIMEReasonerRules.OverlapsEqualsEntailment);

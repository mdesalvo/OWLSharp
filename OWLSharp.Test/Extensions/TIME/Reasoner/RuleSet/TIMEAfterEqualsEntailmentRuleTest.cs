...
namespace OWLSharp.Test.Extensions.TIME
{
    ...
    public class TIMEAfterEqualsEntailmentRuleTest : TIMEBaseEntailmentRuleTest
    {
        #region Tests
        [TestMethod]
        public async Task ShouldExecuteAfterEqualsEntailment()
        {
        ...
        [TestMethod]
        public async Task ShouldExecuteAfterEqualsEntailmentViaReasoner()
        {
            OWLOntology ontology = new OWLOntology(TestOntology);
            ontology.DeclareIntervalFeature(new RDFResource("ex:Feature1"), new TIMEInterval(new RDFResource("ex:Interval1")));
            ontology.DeclareIntervalFeature(new RDFResource("ex:Feature2"), new TIMEInterval(new RDFResource("ex:Interval2")));
            ...
            TIMEReasoner reasoner = new TIMEReasoner().AddRule(TIMEEnums.TIMEReasonerRules.AfterEqualsEntailment);

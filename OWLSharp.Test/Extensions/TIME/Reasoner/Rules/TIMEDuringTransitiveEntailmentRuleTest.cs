...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEDuringTransitiveEntailmentRuleTest
    {
        ...
        public void ShouldExecuteDuringTransitiveEntailment()
        {
            ...
            ontology.DeclareTimeIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval2Name")), new TIMEInterval(new RDFResource("ex:Interval3Name")), TIMEEnums.TIMEIntervalRelation.During);

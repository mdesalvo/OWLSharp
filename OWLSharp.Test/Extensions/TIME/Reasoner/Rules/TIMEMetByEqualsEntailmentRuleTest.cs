...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEMetByEqualsEntailmentRuleTest
    {
        ...
        public void ShouldExecuteMetByEqualsEntailment()
        {
            ...
            ontology.DeclareTimeIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval1Name")), new TIMEInterval(new RDFResource("ex:Interval2Name")), TIMEEnums.TIMEIntervalRelation.MetBy);

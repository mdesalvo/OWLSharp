...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEOverlapsEqualsEntailmentRuleTest
    {
        ...
        public void ShouldExecuteOverlapsEqualsEntailment()
        {
            ...
            ontology.DeclareTimeIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval1Name")), new TIMEInterval(new RDFResource("ex:Interval2Name")), TIMEEnums.TIMEIntervalRelation.Overlaps);

...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEAfterTransitiveEntailmentRuleTest
    {
        ...
        public void ShouldExecuteAfterTransitiveEntailment()
        {
            ...
            ontology.DeclareIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval3Name")), new TIMEInterval(new RDFResource("ex:Interval1Name")), TIMEEnums.TIMEIntervalRelation.After);

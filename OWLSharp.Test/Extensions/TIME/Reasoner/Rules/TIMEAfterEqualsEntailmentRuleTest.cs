...
{
    [TestClass]
    public class TIMEAfterEqualsEntailmentRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldExecuteAfterEqualsEntailment()
        {
            ...
            OWLReasonerReport reasonerReport = TIMEAfterEqualsEntailmentRule.ExecuteRule(ontology);
        ...
        [TestMethod]
        public void ShouldExecuteAfterEqualsEntailmentViaReasoner()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
            ontology.InitializeTIME();
            ontology.DeclareTimeInterval(new RDFResource("ex:Interval1"), new TIMEInterval(new RDFResource("ex:Interval1Name")));
            ...
            OWLReasoner reasoner = new OWLReasoner().AddTIMERule(TIMEEnums.TIMEReasonerRules.TIME_AfterEqualsEntailment);

...
{
    [TestClass]
    public class TIMEBeforeMeetsEntailmentRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldExecuteBeforeMeetsEntailment()
        {
            ...
            ontology.DeclareTimeIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval2Name")), new TIMEInterval(new RDFResource("ex:Interval3Name")), TIMEEnums.TIMEIntervalRelation.Meets);
            OWLReasonerReport reasonerReport = TIMEBeforeMeetsEntailmentRule.ExecuteRule(ontology);
        ...
        [TestMethod]
        public void ShouldExecuteBeforeMeetsEntailmentViaReasoner()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
            ontology.InitializeTIME();
            ontology.DeclareTimeInterval(new RDFResource("ex:Interval1"), new TIMEInterval(new RDFResource("ex:Interval1Name")));
            ...
            OWLReasoner reasoner = new OWLReasoner().AddTIMERule(TIMEEnums.TIMEReasonerRules.TIME_BeforeMeetsEntailment);

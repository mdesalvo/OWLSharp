...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEBeforeMeetsEntailmentRuleTest
    {
        ...
        public void ShouldExecuteBeforeMeetsEntailment()
        {
            ...
            ontology.DeclareIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval2Name")), new TIMEInterval(new RDFResource("ex:Interval3Name")), TIMEEnums.TIMEIntervalRelation.Meets);

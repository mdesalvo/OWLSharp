...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEAfterFinishesEntailmentRuleTest
    {
        ...
        public void ShouldExecuteAfterFinishesEntailment()
        {
            ...
            ontology.DeclareTimeIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval2Name")), new TIMEInterval(new RDFResource("ex:Interval3Name")), TIMEEnums.TIMEIntervalRelation.Finishes);

...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEAfterMetByEntailmentRuleTest
    {
        ...
        public void ShouldExecuteAfterMetByEntailment()
        {
            ...
            ontology.DeclareIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval2Name")), new TIMEInterval(new RDFResource("ex:Interval3Name")), TIMEEnums.TIMEIntervalRelation.MetBy);

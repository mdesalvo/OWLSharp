...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEOverlappedByEqualsEntailmentRuleTest
    {
        ...
        public void ShouldExecuteOverlappedByEqualsEntailment()
        {
            ...
            ontology.DeclareIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval1Name")), new TIMEInterval(new RDFResource("ex:Interval2Name")), TIMEEnums.TIMEIntervalRelation.OverlappedBy);

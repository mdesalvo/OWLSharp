...
namespace OWLSharp.Extensions.TIME.Test
{
    ...
    public class TIMEEqualsTransitiveEntailmentRuleTest
    {
        ...
        public void ShouldExecuteEqualsTransitiveEntailment()
        {
            ...
            ontology.DeclareIntervalRelation(new TIMEInterval(new RDFResource("ex:Interval1Name")), new TIMEInterval(new RDFResource("ex:Interval2Name")), TIMEEnums.TIMEIntervalRelation.Equals);

...
{
    [TestClass]
    public class TIMEBeforeEqualsEntailmentRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldExecuteBeforeEqualsEntailment()
        {
            ...
            OWLReasonerReport reasonerReport = TIMEBeforeEqualsEntailmentRule.ExecuteRule(ontology);
        ...
        [TestMethod]
        public void ShouldExecuteBeforeEqualsEntailmentViaReasoner()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
            ontology.InitializeTIME();
            ontology.DeclareInterval(new RDFResource("ex:Interval1"), new TIMEInterval(new RDFResource("ex:Interval1Name")));
            ...
            OWLReasoner reasoner = new OWLReasoner().AddTIMERule(TIMEEnums.TIMEReasonerRules.TIME_BeforeEqualsEntailment);

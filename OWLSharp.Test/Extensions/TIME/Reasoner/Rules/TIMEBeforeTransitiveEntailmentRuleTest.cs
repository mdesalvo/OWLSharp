...
{
    [TestClass]
    public class TIMEBeforeTransitiveEntailmentRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldExecuteBeforeTransitiveEntailment()
        {
        ...
        [TestMethod]
        public void ShouldExecuteBeforeTransitiveEntailmentViaReasoner()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
            ontology.InitializeTIME();
            ontology.DeclareTimeInterval(new RDFResource("ex:Interval1"), new TIMEInterval(new RDFResource("ex:Interval1Name")));

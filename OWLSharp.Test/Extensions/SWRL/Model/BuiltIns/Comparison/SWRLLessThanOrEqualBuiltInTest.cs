...
namespace OWLSharp.Test.Extensions.SWRL.Model.BuiltIns
{
    ...
    public class SWRLLessThanOrEqualBuiltInTest
    {
        ...
        {
            SWRLLessThanOrEqualBuiltIn builtin = new SWRLLessThanOrEqualBuiltIn(new RDFVariable("?L"), new RDFVariable("?R"));

            Assert.IsNotNull(builtin);
            Assert.IsNotNull(builtin.BuiltInFilter);
            Assert.IsNotNull(builtin.Predicate);
            Assert.IsTrue(builtin.Predicate.GetIRI().Equals(new RDFResource("swrlb:lessThanOrEqual")));
        ...
        {
            SWRLLessThanOrEqualBuiltIn builtin = new SWRLLessThanOrEqualBuiltIn(new RDFVariable("?L"), new RDFResource("ex:res"));
        ...
        {
            SWRLLessThanOrEqualBuiltIn builtin = new SWRLLessThanOrEqualBuiltIn(new RDFVariable("?L"), new RDFTypedLiteral("25", RDFModelEnums.RDFDatatypes.XSD_INTEGER));
        ...
        public void ShouldThrowExceptionOnCreatingLessThanOrEqualBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new SWRLLessThanOrEqualBuiltIn(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingLessThanOrEqualBuiltInBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLException>(() => new SWRLLessThanOrEqualBuiltIn(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingLessThanOrEqualBuiltInBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLException>(() => new SWRLLessThanOrEqualBuiltIn(new RDFVariable("?L"), null as RDFResource));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingLessThanOrEqualBuiltInBecauseNullRightArgumentLiteral()
            => Assert.ThrowsException<OWLException>(() => new SWRLLessThanOrEqualBuiltIn(new RDFVariable("?L"), null as RDFLiteral));
        ...
        public void ShouldEvaluateLessThanOrEqualEqualBuiltIn()
        {
            ...
            SWRLLessThanOrEqualBuiltIn builtin = new SWRLLessThanOrEqualBuiltIn(new RDFVariable("?C"), new RDFResource("ex:indiv1"));

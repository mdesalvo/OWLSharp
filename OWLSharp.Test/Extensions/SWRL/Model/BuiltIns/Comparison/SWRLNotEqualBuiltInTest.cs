...
namespace OWLSharp.Test.Extensions.SWRL.Model.BuiltIns
{
    ...
    public class SWRLNotEqualBuiltInTest
    {
        ...
        {
            SWRLNotEqualBuiltIn builtin = new SWRLNotEqualBuiltIn(new RDFVariable("?L"), new RDFVariable("?R"));

            Assert.IsNotNull(builtin);
            Assert.IsNotNull(builtin.BuiltInFilter);
            Assert.IsNotNull(builtin.Predicate);
            Assert.IsTrue(builtin.Predicate.GetIRI().Equals(new RDFResource("swrlb:notEqual")));
        ...
        {
            SWRLNotEqualBuiltIn builtin = new SWRLNotEqualBuiltIn(new RDFVariable("?L"), new RDFResource("ex:res"));
        ...
        {
            SWRLNotEqualBuiltIn builtin = new SWRLNotEqualBuiltIn(new RDFVariable("?L"), new RDFTypedLiteral("25", RDFModelEnums.RDFDatatypes.XSD_INTEGER));
        ...
        public void ShouldThrowExceptionOnCreatingNotEqualBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new SWRLNotEqualBuiltIn(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingNotEqualBuiltInBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLException>(() => new SWRLNotEqualBuiltIn(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingNotEqualBuiltInBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLException>(() => new SWRLNotEqualBuiltIn(new RDFVariable("?L"), null as RDFResource));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingNotEqualBuiltInBecauseNullRightArgumentLiteral()
            => Assert.ThrowsException<OWLException>(() => new SWRLNotEqualBuiltIn(new RDFVariable("?L"), null as RDFLiteral));
        ...
        public void ShouldEvaluateNotEqualBuiltIn()
        {
            ...
            SWRLNotEqualBuiltIn builtin = new SWRLNotEqualBuiltIn(new RDFVariable("?C"), new RDFResource("ex:indiv2"));

...
namespace OWLSharp.Test.Extensions.SWRL.Model.BuiltIns
{
    ...
    public class SWRLLessThanBuiltInTest
    {
        ...
        {
            SWRLLessThanBuiltIn builtin = new SWRLLessThanBuiltIn(new RDFVariable("?L"), new RDFVariable("?R"));

            Assert.IsNotNull(builtin);
            Assert.IsNotNull(builtin.BuiltInFilter);
            Assert.IsNotNull(builtin.Predicate);
            Assert.IsTrue(builtin.Predicate.GetIRI().Equals(new RDFResource("swrlb:lessThan")));
        ...
        {
            SWRLLessThanBuiltIn builtin = new SWRLLessThanBuiltIn(new RDFVariable("?L"), new RDFResource("ex:res"));
        ...
        {
            SWRLLessThanBuiltIn builtin = new SWRLLessThanBuiltIn(new RDFVariable("?L"), new RDFTypedLiteral("25", RDFModelEnums.RDFDatatypes.XSD_INTEGER));
        ...
        public void ShouldThrowExceptionOnCreatingLessThanBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new SWRLLessThanBuiltIn(null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingLessThanBuiltInBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLException>(() => new SWRLLessThanBuiltIn(new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingLessThanBuiltInBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLException>(() => new SWRLLessThanBuiltIn(new RDFVariable("?L"), null as RDFResource));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingLessThanBuiltInBecauseNullRightArgumentLiteral()
            => Assert.ThrowsException<OWLException>(() => new SWRLLessThanBuiltIn(new RDFVariable("?L"), null as RDFLiteral));
        ...
        public void ShouldEvaluateLessThanEqualBuiltIn()
        {
            ...
            SWRLLessThanBuiltIn builtin = new SWRLLessThanBuiltIn(new RDFVariable("?C"), new RDFResource("ex:indiv2"));

...
namespace OWLSharp.Extensions.SWRL.Test
{
    ...
    public class SWRLObjectPropertyAtomTest
    {
        ...
        {
            SWRLObjectPropertyAtom ObjectPropertyAtom = new SWRLObjectPropertyAtom(new RDFResource("ex:objprop"), new RDFVariable("?L"), new RDFVariable("?R"));
        ...
        {
            SWRLObjectPropertyAtom ObjectPropertyAtom = new SWRLObjectPropertyAtom(new RDFResource("ex:objprop"), new RDFVariable("?L"), new RDFResource("ex:val"));
        ...
        public void ShouldThrowExceptionOnCreatingObjectPropertyAtomBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new SWRLObjectPropertyAtom(new RDFResource("ex:objprop"), null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingObjectPropertyAtomBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLException>(() => new SWRLObjectPropertyAtom(new RDFResource("ex:objprop"), new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingObjectPropertyAtomBecauseNullRightArgumentResource()
            => Assert.ThrowsException<OWLException>(() => new SWRLObjectPropertyAtom(new RDFResource("ex:objprop"), new RDFVariable("?L"), null as RDFResource));
        ...
        {
            SWRLObjectPropertyAtom ObjectPropertyAtom = new SWRLObjectPropertyAtom(new RDFResource("ex:objprop"), new RDFVariable("?L"), new RDFResource("ex:val1"));

...
{
    [TestClass]
    public class OWLReasonerRuleClassAtomTest
    {
        #region Tests
        [TestMethod]
        ...
        public void ShouldThrowExceptionOnCreatingClassAtomBecauseNullPredicate()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleClassAtom(null, new RDFVariable("?C")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingClassAtomBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleClassAtom(new RDFResource("ex:class"), null));

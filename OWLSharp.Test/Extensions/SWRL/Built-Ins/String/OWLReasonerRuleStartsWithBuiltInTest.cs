...
namespace OWLSharp.Extensions.SWRL.Test
{
    ...
    public class OWLReasonerRuleStartsWithBuiltInTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingStartsWithBuiltInBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleStartsWithBuiltIn(null, "val"));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingStartsWithBuiltInBecauseNullRightArgument()
            => Assert.ThrowsException<OWLException>(() => new OWLReasonerRuleStartsWithBuiltIn(new RDFVariable("?L"), null));

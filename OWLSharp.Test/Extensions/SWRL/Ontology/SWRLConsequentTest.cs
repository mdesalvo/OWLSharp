    ...
    public class SWRLConsequentTest
    {
        ...
        public void ShouldAddAtoms()
        {
            SWRLConsequent consequent = new SWRLConsequent()
                ...
                .AddAtom(new SWRLObjectPropertyAtom(new RDFResource("ex:objprop"), new RDFVariable("?C"), new RDFVariable("?I")));
        ...
        public void ShouldEvaluate()
        {
            ...
            SWRLConsequent consequent = new SWRLConsequent()
                .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.RDF.TYPE, new RDFVariable("?C"), RDFVocabulary.OWL.INDIVIDUAL));

...
namespace OWLSharp.Extensions.SWRL.Test
{
    ...
    public class SWRLDataPropertyAtomTest
    {
        ...
        {
            SWRLDataPropertyAtom DataPropertyAtom = new SWRLDataPropertyAtom(new RDFResource("ex:dtprop"), new RDFVariable("?L"), new RDFVariable("?R"));
        ...
        {
            SWRLDataPropertyAtom DataPropertyAtom = new SWRLDataPropertyAtom(new RDFResource("ex:dtprop"), new RDFVariable("?L"), new RDFPlainLiteral("hello","en-US"));
        ...
        public void ShouldThrowExceptionOnCreatingDataPropertyAtomBecauseNullLeftArgument()
            => Assert.ThrowsException<OWLException>(() => new SWRLDataPropertyAtom(new RDFResource("ex:dtprop"), null, new RDFVariable("?R")));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDataPropertyAtomBecauseNullRightArgumentVariable()
            => Assert.ThrowsException<OWLException>(() => new SWRLDataPropertyAtom(new RDFResource("ex:dtprop"), new RDFVariable("?L"), null as RDFVariable));

        [TestMethod]
        public void ShouldThrowExceptionOnCreatingDataPropertyAtomBecauseNullRightArgumentLiteral()
            => Assert.ThrowsException<OWLException>(() => new SWRLDataPropertyAtom(new RDFResource("ex:dtprop"), new RDFVariable("?L"), null as RDFLiteral));

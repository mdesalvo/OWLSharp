...
namespace OWLSharp.Test.Extensions.SKOS.Validator.RuleSet
{
    ...
    public class SKOSCloseOrExactMatchConceptAnalysisRuleTest
    {
        ...
        public void ShouldAnalyzeCloseOrExactMatchConceptAndViolateRule1B()
        {
            ...
            Assert.IsTrue(string.Equals(issues[0].Suggestion, "SKOS concepts 'ex:ConceptA' and 'ex:ConceptB' belonging to the same schema should be adjusted to not clash on associative/mapping relations (skos:closeMatch VS skos:relatedMatch)"));
        }
        ...
        public void ShouldAnalyzeCloseOrExactMatchConceptAndViolateRule2A()
        {
            ...
            Assert.IsTrue(string.Equals(issues[0].Suggestion, "SKOS concepts 'ex:ConceptA' and 'ex:ConceptB' belonging to the same schema should be adjusted to not clash on associative/mapping relations (skos:exactMatch VS skos:related)"));
        }
        ...
        public void ShouldAnalyzeCloseOrExactMatchConceptAndViolateRule2B()
        {
            ...
            Assert.IsTrue(string.Equals(issues[0].Suggestion, "SKOS concepts 'ex:ConceptA' and 'ex:ConceptB' belonging to the same schema should be adjusted to not clash on associative/mapping relations (skos:exactMatch VS skos:relatedMatch)"));
        }
        #endregion
    }
}
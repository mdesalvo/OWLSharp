...
namespace OWLSharp.Extensions.SKOS.Test
{
    ...
    public class SKOSHiddenLabelRuleTest
    {
        ...
        public void ShouldValidateHiddenLabel()
        {
            ...
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept3"), RDFVocabulary.SKOS.HIDDEN_LABEL, new RDFPlainLiteral("concept3", "en"));
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept3"), RDFVocabulary.SKOS.ALT_LABEL, new RDFPlainLiteral("concept3", "en")); //clash
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept2"), RDFVocabulary.SKOS.HIDDEN_LABEL, new RDFPlainLiteral("concept2"));
        ...
        public void ShouldValidateHiddenLabelViaValidator()
        {
            ...
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept3"), RDFVocabulary.SKOS.ALT_LABEL, new RDFPlainLiteral("concept3", "en")); //clash
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept2"), RDFVocabulary.SKOS.HIDDEN_LABEL, new RDFPlainLiteral("concept2"));
            ontology.Data.DeclareObjectAssertion(new RDFResource("ex:concept2"), RDFVocabulary.SKOS.SKOSXL.ALT_LABEL, new RDFResource("ex:label2"));
            ontology.Data.DeclareDatatypeAssertion(new RDFResource("ex:label2"), RDFVocabulary.SKOS.SKOSXL.LITERAL_FORM, new RDFPlainLiteral("concept2")); //clash

...
{
    [TestClass]
    public class SKOSHiddenLabelRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldValidateHiddenLabel()
        {
            ...
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept1"), RDFVocabulary.SKOS.HIDDEN_LABEL, new RDFPlainLiteral("concept1", "en-US"));
            ...
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept1"), RDFVocabulary.SKOS.HIDDEN_LABEL, new RDFPlainLiteral("concept1", "en"));
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept1"), RDFVocabulary.SKOS.ALT_LABEL, new RDFPlainLiteral("concept1", "en")); //annotation clash
            ontology.Data.DeclareObjectAssertion(new RDFResource("ex:concept1"), RDFVocabulary.SKOS.SKOSXL.HIDDEN_LABEL, new RDFResource("ex:label1A"));
            ...
            OWLValidatorReport validatorReport = SKOSHiddenLabelRule.ExecuteRule(ontology);
        ...
        [TestMethod]
        public void ShouldValidateHiddenLabelViaValidator()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
            ontology.InitializeSKOS();
            ontology.DeclareConcept(new RDFResource("ex:concept1"), new RDFResource("ex:conceptSchemeA"));
            ...
            ontology.Data.DeclareObjectAssertion(new RDFResource("ex:concept1"), RDFVocabulary.SKOS.SKOSXL.HIDDEN_LABEL, new RDFResource("ex:label1A"));
            ontology.Data.DeclareDatatypeAssertion(new RDFResource("ex:label1A"), RDFVocabulary.SKOS.SKOSXL.LITERAL_FORM, new RDFPlainLiteral("concept1"));
            ontology.Data.DeclareObjectAssertion(new RDFResource("ex:concept1"), RDFVocabulary.SKOS.SKOSXL.ALT_LABEL, new RDFResource("ex:label1B"));
            ontology.Data.DeclareDatatypeAssertion(new RDFResource("ex:label1B"), RDFVocabulary.SKOS.SKOSXL.LITERAL_FORM, new RDFPlainLiteral("concept1")); //relation clash
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept2"), RDFVocabulary.SKOS.ALT_LABEL, new RDFPlainLiteral("concept2", "en-US"));
            ontology.Data.AnnotateIndividual(new RDFResource("ex:concept2"), RDFVocabulary.SKOS.PREF_LABEL, new RDFPlainLiteral("concept2", "en"));

            OWLValidator validator = new OWLValidator().AddSKOSRule(SKOSEnums.SKOSValidatorRules.HiddenLabel);

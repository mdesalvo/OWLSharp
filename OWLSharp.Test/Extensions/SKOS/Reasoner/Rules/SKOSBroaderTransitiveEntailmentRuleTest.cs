...
{
    [TestClass]
    public class SKOSBroaderTransitiveEntailmentRuleTest
    {
        #region Tests
        [TestMethod]
        public void ShouldExecuteBroaderTransitiveEntailment()
        {
            ...
            ontology.DeclareBroaderTransitiveConcepts(new RDFResource("ex:Concept1"), new RDFResource("ex:Concept2"));
            ontology.DeclareBroaderTransitiveConcepts(new RDFResource("ex:Concept2"), new RDFResource("ex:Concept3"));
            OWLReasonerReport reasonerReport = SKOSBroaderTransitiveEntailmentRule.ExecuteRule(ontology);
        ...
        [TestMethod]
        public void ShouldExecuteBroaderTransitiveEntailmentViaReasoner()
        {
            OWLOntology ontology = new OWLOntology("ex:ont");
            ontology.InitializeSKOS();
            ontology.DeclareConcept(new RDFResource("ex:Concept1"), new RDFResource("ex:ConceptScheme"));
            ...
            OWLReasoner reasoner = new OWLReasoner().AddSKOSRule(SKOSEnums.SKOSReasonerRules.SKOS_BroaderTransitiveEntailment);

    ...
    public class SKOSOntologyLensTest
    {
        ...
        public void Initialize()
        {
            Ontology = new OWLOntology("ex:ont")
                ...
                .AnnotateConceptPreferredLabel(new RDFResource("ex:concept1"), new RDFPlainLiteral("concept1"))
                .AnnotateConceptAlternativeLabel(new RDFResource("ex:concept1"), new RDFPlainLiteral("konzept1"))
                .AnnotateConceptHiddenLabel(new RDFResource("ex:concept1"), new RDFPlainLiteral("concetto1"))
                ...
                .DeclareCollection(new RDFResource("ex:collection1"), [new RDFResource("ex:concept1"), new RDFResource("ex:collection2")], new RDFResource("ex:conceptScheme"))
                ...
                .DeclareCollection(new RDFResource("ex:collection2"), [new RDFResource("ex:concept2"), new RDFResource("ex:collection1")], new RDFResource("ex:conceptScheme"))    

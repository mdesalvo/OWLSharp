...
namespace OWLSharp
{
    public static class OWLEnums
    {
		...
		public enum OWLValidatorRules
		{
			...
			DifferentIndividualsAnalysis = 4,
			DisjointClassesAnalysis = 5,
			DisjointDataPropertiesAnalysis = 6,
			DisjointObjectPropertiesAnalysis = 7,
			DisjointUnionAnalysis = 8,
			EquivalentClassesAnalysis = 9,
			EquivalentDataPropertiesAnalysis = 10,
			EquivalentObjectPropertiesAnalysis = 11,
			FunctionalDataPropertyAnalysis = 12,
			FunctionalObjectPropertyAnalysis = 13,
			HasKeyAnalysis = 14,
			InverseFunctionalObjectPropertyAnalysis = 15,
			IrreflexiveObjectPropertyAnalysis = 16,
			NegativeDataAssertionsAnalysis = 17,
			NegativeObjectAssertionsAnalysis = 18,
			ObjectPropertyChainAnalysis = 19,
			SubClassOfAnalysis = 20,
			SubDataPropertyOfAnalysis = 21,
			SubObjectPropertyOfAnalysis = 22,
			TermsDeprecationAnalysis = 23,
			TermsDisjointnessAnalysis = 24,
            ThingNothingAnalysis = 25,
			TopBottomAnalysis = 26
		}
    }
}
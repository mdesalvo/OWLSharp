...
namespace OWLSharp.Extensions.SWRL.Atoms
{
    ...
    {
        #region Ctors
        public SWRLNegativeObjectPropertyAtom(OWLObjectProperty owlObjectProperty, RDFVariable leftArgument, RDFVariable rightArgument)
        ...
        public SWRLNegativeObjectPropertyAtom(OWLObjectProperty owlObjectProperty, RDFVariable leftArgument, RDFResource rightArgument)
            : base(owlObjectProperty, leftArgument, rightArgument) 
        {
            #region Guards
            if (rightArgument == null)
        ...
        internal override DataTable EvaluateOnAntecedent(OWLOntology ontology)
        {
			...
			List<OWLNegativeObjectPropertyAssertion> opAsns = ontology.GetAssertionAxiomsOfType<OWLNegativeObjectPropertyAssertion>();
            List<OWLNegativeObjectPropertyAssertion> atomPredicateNegativeAssertions = OWLAssertionAxiomHelper.SelectNegativeObjectAssertionsByOPEX(opAsns, (OWLObjectProperty)Predicate);
            #region Calibration

...
{
    /// <summary>
    /// SWRLObjectPropertyAtom represents a SWRL atom inferring object relations between individuals
    /// </summary>
    public class SWRLObjectPropertyAtom : SWRLAtom
    {
        ...
        /// </summary>
        public SWRLObjectPropertyAtom(RDFResource owlObjectProperty, RDFVariable leftArgument, RDFVariable rightArgument)
        ...
        /// Default-ctor to build an object property atom with the given property and arguments
        /// </summary>
        public SWRLObjectPropertyAtom(RDFResource owlObjectProperty, RDFVariable leftArgument, RDFResource rightArgument)
            : base(owlObjectProperty, leftArgument, rightArgument)
        {
            if (rightArgument == null)
                throw new OWLException("Cannot create atom because given \"rightArgument\" parameter is null");

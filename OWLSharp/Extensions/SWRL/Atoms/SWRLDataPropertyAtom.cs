...
{
    /// <summary>
    /// SWRLDataPropertyAtom represents a SWRL atom inferring datatype atomPredicateAssertions
    /// </summary>
    public class SWRLDataPropertyAtom : SWRLAtom
    {
        ...
        /// </summary>
        public SWRLDataPropertyAtom(RDFResource owlDatatypeProperty, RDFVariable leftArgument, RDFVariable rightArgument)
        ...
        /// Default-ctor to build a data property atom with the given property and arguments
        /// </summary>
        public SWRLDataPropertyAtom(RDFResource owlDatatypeProperty, RDFVariable leftArgument, RDFLiteral rightArgument)
            : base(owlDatatypeProperty, leftArgument, rightArgument) 
        {
            if (rightArgument == null)
                throw new OWLException("Cannot create atom because given \"rightArgument\" parameter is null");

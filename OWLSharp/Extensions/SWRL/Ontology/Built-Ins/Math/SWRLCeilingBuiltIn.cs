...
{
    /// <summary>
    /// SWRLCeilingBuiltIn represents a SWRL built-in filtering inferences of a rule's antecedent on a swrlb:ceiling basis
    /// </summary>
    public class SWRLCeilingBuiltIn : SWRLMathBuiltIn
    {
        ...
        /// </summary>
        public SWRLCeilingBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)

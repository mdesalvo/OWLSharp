...
{
    /// <summary>
    /// SWRLRoundHalfToEvenBuiltIn represents a SWRL built-in filtering inferences of a rule's antecedent on a swrlb:roundHalfToEven basis
    /// </summary>
    public class SWRLRoundHalfToEvenBuiltIn : SWRLMathBuiltIn
    {
        #region Properties
        /// <summary>
        ...
        /// </summary>
        public SWRLRoundHalfToEvenBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)

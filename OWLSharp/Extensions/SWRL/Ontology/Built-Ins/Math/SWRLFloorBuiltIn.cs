...
{
    /// <summary>
    /// SWRLFloorBuiltIn represents a SWRL built-in filtering inferences of a rule's antecedent on a swrlb:floor basis
    /// </summary>
    public class SWRLFloorBuiltIn : SWRLMathBuiltIn
    {
        ...
        /// </summary>
        public SWRLFloorBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)

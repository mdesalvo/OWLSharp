...
{
    /// <summary>
    /// SWRLSinBuiltIn represents a SWRL built-in filtering inferences of a rule's antecedent on a swrlb:sin basis
    /// </summary>
    public class SWRLSinBuiltIn : SWRLMathBuiltIn
    {
        #region Properties
        /// <summary>
        ...
        /// </summary>
        public SWRLSinBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)

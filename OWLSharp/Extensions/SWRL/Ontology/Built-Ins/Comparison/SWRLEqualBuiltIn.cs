...
{
    /// <summary>
    /// SWRLEqualBuiltInrepresents a SWRL built-in filtering inferences of a rule's antecedent on a swrlb:equal basis
    /// </summary>
    public class SWRLEqualBuiltIn : SWRLFilterBuiltIn
    {
        #region Properties
        /// <summary>

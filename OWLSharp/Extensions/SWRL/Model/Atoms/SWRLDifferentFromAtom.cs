...
{
    public class SWRLDifferentFromAtom : SWRLAtom
    {
        internal static readonly OWLObjectProperty DifferentFrom = new OWLObjectProperty(RDFVocabulary.OWL.DIFFERENT_FROM);

...
{
    /// <summary>
    /// SWRLAntecedent represents the antecedent of a reasoner rule expressed in SWRL
    /// </summary>
    public class SWRLAntecedent
    {
        ...
        /// </summary>
        internal List<SWRLAtom> Atoms { get; set; }
        #endregion
        ...
        /// </summary>
        public SWRLAntecedent AddAtom(SWRLAtom atom)
        {
        ...
        /// </summary>
        public SWRLAntecedent AddBuiltIn(SWRLBuiltIn builtIn)
            => AddAtom(builtIn);

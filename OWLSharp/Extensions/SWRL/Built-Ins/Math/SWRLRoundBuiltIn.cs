...
{
    /// <summary>
    /// SWRLRoundBuiltIn represents a SWRL built-in filtering inferences of a rule's antecedent on a swrlb:round basis
    /// </summary>
    public class SWRLRoundBuiltIn : SWRLMathBuiltIn
    {
        ...
        /// </summary>
        public SWRLRoundBuiltIn(RDFVariable leftArgument, RDFVariable rightArgument)

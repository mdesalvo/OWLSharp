...
{
    /// <summary>
    /// Represents the definition of a reference system for expressing ordinal-based temporal extents (e.g: Geologic TimeScale)
    /// </summary>
    public class TIMEOrdinalReferenceSystem : TIMEReferenceSystem
    {
            ...
            : base(trsUri)
        {
            ...
            Ontology.Data.DeclareIndividualType(trsUri, RDFVocabulary.TIME.THORS.REFERENCE_SYSTEM);
        }
        #endregion
        ...
        #region Declarer
        /// <summary>
        /// Declares the existence of the given era, having the given boundaries, to the ordinal TRS
        /// </summary>
        public TIMEOrdinalReferenceSystem DeclareEra(RDFResource era, TIMEInstant eraBeginning, TIMEInstant eraEnd)
        {
            ...
            Ontology.Data.DeclareIndividual(era);
            Ontology.Data.DeclareIndividualType(era, RDFVocabulary.TIME.THORS.ERA);

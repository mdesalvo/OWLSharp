...
{
    internal static class TIMEAfterMetByEntailmentRule
    {
            ...
            SWRLRule swrlRule = new SWRLRule(
                ...
                new SWRLAntecedent
                {
                    Atoms = new List<SWRLAtom>
                    {
                        ...
                        new SWRLObjectPropertyAtom(new OWLObjectProperty(RDFVocabulary.TIME.INTERVAL_MET_BY), new SWRLVariableArgument(new RDFVariable("?I2")), new SWRLVariableArgument(new RDFVariable("?I3")))
                    },

...
{
    /// <summary>
    /// Given temporal intervals I1, I2 and I3: DURING(?I1,?I2) ^ DURING(?I2,?I3) -> DURING(?I1,?I3)
    /// </summary>
    internal static class TIMEDuringTransitiveEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEDuringTransitiveEntailmentRule),
                ...
                new SWRLAntecedent()
                    ...
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_DURING, new RDFVariable("?I1"), new RDFVariable("?I2")))
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_DURING, new RDFVariable("?I2"), new RDFVariable("?I3")))
                ...
                new SWRLConsequent()
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_DURING, new RDFVariable("?I1"), new RDFVariable("?I3"))));

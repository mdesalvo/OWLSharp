...
{
    /// <summary>
    /// Given temporal intervals I1, I2 and I3: FINISHES(?I1,?I2) ^ EQUALS(?I2,?I3) -> FINISHES(?I1,?I3)
    /// </summary>
    internal static class TIMEFinishesEqualsEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEFinishesEqualsEntailmentRule),
                ...
                new SWRLConsequent()
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_FINISHES, new RDFVariable("?I1"), new RDFVariable("?I3"))));

    ...
    internal static class TIMEEqualsTransitiveEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEEqualsTransitiveEntailmentRule),
                ...
                new SWRLConsequent()
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_EQUALS, new RDFVariable("?I1"), new RDFVariable("?I3")))
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_EQUALS, new RDFVariable("?I3"), new RDFVariable("?I1"))));

...
{
    /// <summary>
    /// Given temporal intervals I1, I2 and I3: CONTAINS(?I1,?I2) ^ CONTAINS(?I2,?I3) -> CONTAINS(?I1,?I3)
    /// </summary>
    internal static class TIMEContainsTransitiveEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEContainsTransitiveEntailmentRule),
                ...
                new SWRLAntecedent()
                    ...
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_CONTAINS, new RDFVariable("?I1"), new RDFVariable("?I2")))
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_CONTAINS, new RDFVariable("?I2"), new RDFVariable("?I3")))
                ...
                new SWRLConsequent()
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_CONTAINS, new RDFVariable("?I1"), new RDFVariable("?I3"))));

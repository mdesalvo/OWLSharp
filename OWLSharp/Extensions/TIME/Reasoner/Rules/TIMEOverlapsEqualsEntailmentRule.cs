...
{
    /// <summary>
    /// Given temporal intervals I1, I2 and I3: OVERLAPS(?I1,?I2) ^ EQUALS(?I2,?I3) -> OVERLAPS(?I1,?I3)
    /// </summary>
    internal static class TIMEOverlapsEqualsEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEOverlapsEqualsEntailmentRule),
                ...
                new SWRLAntecedent()
                    ...
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_OVERLAPS, new RDFVariable("?I1"), new RDFVariable("?I2")))
                ...
                new SWRLConsequent()
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_OVERLAPS, new RDFVariable("?I1"), new RDFVariable("?I3"))));

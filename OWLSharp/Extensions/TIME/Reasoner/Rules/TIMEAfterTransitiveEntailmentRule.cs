...
{
    /// <summary>
    /// Given temporal intervals I1, I2 and I3: AFTER(?I1,?I2) ^ AFTER(?I3,?I1) -> AFTER(?I3,?I2)
    /// </summary>
    internal static class TIMEAfterTransitiveEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEAfterTransitiveEntailmentRule),
                ...
                new SWRLAntecedent()
                    ...
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_AFTER, new RDFVariable("?I3"), new RDFVariable("?I1")))
                ...
                new SWRLConsequent()
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_AFTER, new RDFVariable("?I3"), new RDFVariable("?I2"))));

...
{
    /// <summary>
    /// Given temporal intervals I1, I2 and I3: AFTER(?I1,?I2) ^ METBY(?I2,?I3) -> AFTER(?I1,?I3)
    /// </summary>
    internal static class TIMEAfterMetByEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEAfterMetByEntailmentRule),
                ...
                new SWRLAntecedent()
                    ...
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_MET_BY, new RDFVariable("?I2"), new RDFVariable("?I3")))

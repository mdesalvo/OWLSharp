...
{
    /// <summary>
    /// Given temporal intervals I1, I2 and I3: BEFORE(?I1,?I2) ^ BEFORE(?I3,?I1) -> BEFORE(?I3,?I2)
    /// </summary>
    internal static class TIMEBeforeTransitiveEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEBeforeTransitiveEntailmentRule),
                ...
                new SWRLAntecedent()
                    ...
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_BEFORE, new RDFVariable("?I3"), new RDFVariable("?I1")))
                ...
                new SWRLConsequent()
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_BEFORE, new RDFVariable("?I3"), new RDFVariable("?I2"))));

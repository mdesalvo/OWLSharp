...
{
    /// <summary>
    /// Given temporal intervals I1, I2 and I3: BEFORE(?I1,?I2) ^ MEETS(?I2,?I3) -> BEFORE(?I1,?I3)
    /// </summary>
    internal static class TIMEBeforeMeetsEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEBeforeMeetsEntailmentRule),
                ...
                new SWRLAntecedent()
                    ...
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_BEFORE, new RDFVariable("?I1"), new RDFVariable("?I2")))
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_MEETS, new RDFVariable("?I2"), new RDFVariable("?I3")))
                ...
                new SWRLConsequent()
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_BEFORE, new RDFVariable("?I1"), new RDFVariable("?I3"))));

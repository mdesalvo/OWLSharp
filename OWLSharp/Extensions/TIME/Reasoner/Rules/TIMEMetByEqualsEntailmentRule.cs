...
{
    /// <summary>
    /// Given temporal intervals I1, I2 and I3: METBY(?I1,?I2) ^ EQUALS(?I2,?I3) -> METBY(?I1,?I3)
    /// </summary>
    internal static class TIMEMetByEqualsEntailmentRule
    {
        internal static OWLReasonerReport ExecuteRule(OWLOntology ontology)
        {
            SWRLRule swrlRule = new SWRLRule(
                nameof(TIMEMetByEqualsEntailmentRule),
                ...
                new SWRLAntecedent()
                    ...
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_MET_BY, new RDFVariable("?I1"), new RDFVariable("?I2")))
                ...
                new SWRLConsequent()
                    .AddAtom(new SWRLObjectPropertyAtom(RDFVocabulary.TIME.INTERVAL_MET_BY, new RDFVariable("?I1"), new RDFVariable("?I3"))));

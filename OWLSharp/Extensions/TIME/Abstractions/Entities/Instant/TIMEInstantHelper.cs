...
namespace OWLSharp.Extensions.TIME
{
    public static class TIMEInstantHelper
    {
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            ...
            TIMECoordinate aTimeInstantCoordinate = timeOntology?.GetCoordinateOfTIMEInstant(aTimeInstantURI, calendarTRS);
            if (aTimeInstantCoordinate == null)
                return false;

            //Retrieve the temporal coordinate of the given time bInstant
            TIMECoordinate bTimeInstantCoordinate = timeOntology?.GetCoordinateOfTIMEInstant(bTimeInstantURI, calendarTRS);
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            ...
            TIMECoordinate timeInstantCoordinate = timeOntology?.GetCoordinateOfTIMEInstant(timeInstantURI, calendarTRS);
            if (timeInstantCoordinate == null)
                return false;

            //Retrieve the temporal coordinate of the given time interval's end instant
            TIMECoordinate timeIntervalEndCoordinate = timeOntology?.GetEndOfTIMEInterval(timeIntervalURI, calendarTRS);
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            ...
            TIMECoordinate timeIntervalBeginningCoordinate = timeOntology?.GetBeginningOfTIMEInterval(timeIntervalURI, calendarTRS);

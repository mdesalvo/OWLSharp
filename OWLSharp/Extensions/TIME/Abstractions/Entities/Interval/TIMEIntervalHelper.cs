...
namespace OWLSharp.Extensions.TIME
{
    public static class TIMEIntervalHelper
    {
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            ...
            TIMECoordinate aTimeIntervalBeginningCoordinate = timeOntology?.GetBeginningOfTIMEInterval(aTimeIntervalURI, calendarTRS);
            if (aTimeIntervalBeginningCoordinate == null)
                return false;

            //Retrieve the temporal coordinate of the given bInterval's end instant
            TIMECoordinate bTimeIntervalEndCoordinate = timeOntology?.GetEndOfTIMEInterval(bTimeIntervalURI, calendarTRS);
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            ...
            TIMECoordinate aTimeIntervalEndCoordinate = timeOntology?.GetEndOfTIMEInterval(aTimeIntervalURI, calendarTRS);
            if (aTimeIntervalEndCoordinate == null)
                return false;

            //Retrieve the temporal coordinate of the given bInterval's beginning instant
            TIMECoordinate bTimeIntervalBeginningCoordinate = timeOntology?.GetBeginningOfTIMEInterval(bTimeIntervalURI, calendarTRS);

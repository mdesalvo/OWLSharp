...
{
    internal static class TIMEIntervalContainsAnalysisRule
    {
        internal static readonly string rulename = nameof(TIMEEnums.TIMEValidatorRules.IntervalContainsAnalysis);

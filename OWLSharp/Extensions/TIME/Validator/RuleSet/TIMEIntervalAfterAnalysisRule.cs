    ...
    internal class TIMEIntervalAfterAnalysisRule
    {
        ...
        internal static async Task<List<OWLIssue>> ExecuteRuleAsync(OWLOntology ontology, Dictionary<string, List<OWLIndividualExpression>> cacheRegistry)
        {
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_AFTER(?INT2,?INT1) -> ERROR", 
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_BEFORE(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_CONTAINS(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_DURING(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_EQUALS(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_FINISHED_BY(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_FINISHES(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ HAS_INSIDE(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_IN(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_MEETS(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_MET_BY(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ NOT_DISJOINT(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_OVERLAPPED_BY(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_OVERLAPS(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_STARTED_BY(?INT1,?INT2) -> ERROR",
            ...
            await ExecuteRuleBodyAsync(
                "INTERVAL_AFTER(?INT1,?INT2) ^ INTERVAL_STARTS(?INT1,?INT2) -> ERROR",

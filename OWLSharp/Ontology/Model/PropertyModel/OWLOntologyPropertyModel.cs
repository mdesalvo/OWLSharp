...
namespace OWLSharp
{
    ...
    public class OWLOntologyPropertyModel : IEnumerable<RDFResource>, IDisposable
    {
        ...
        ///  so at the end you may want to find propertymodel inconsistencies by executing core validator rules)
        /// </summary>
        ...
        /// <summary>
        /// Gets a graph representation of the property model (eventually including current inferences)
        /// </summary>
        ...
        /// <summary>
        /// Asynchronously gets a graph representation of the property model (eventually including current inferences)
        /// </summary>

...
namespace OWLSharp
{
    ...
    public class OWLOntologyPropertyModelLens
    {
        ...
        public List<RDFTriple> ObjectAnnotations()
        {
            ...
            result.AddRange(Ontology.Model.PropertyModel.OBoxGraph.Where(ann => ann.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPO
                                                                                    && Ontology.Model.PropertyModel.CheckHasAnnotationProperty((RDFResource)ann.Predicate)
                                                                                        && ann.Subject.Equals(Property)));
        ...
        public List<RDFTriple> DataAnnotations()
        {
            ...
            result.AddRange(Ontology.Model.PropertyModel.OBoxGraph.Where(ann => ann.TripleFlavor == RDFModelEnums.RDFTripleFlavors.SPL
                                                                                    && Ontology.Model.PropertyModel.CheckHasAnnotationProperty((RDFResource)ann.Predicate)
                                                                                        && ann.Subject.Equals(Property)));

...
{
    /// <summary>
    /// SWRLStartsWithBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#startsWith built-in
    /// </summary>
    internal static class SWRLStartsWithBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(RDFTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            if (isStringLeftPM && isStringRightPM)
            {
                ...
                return leftPMValue.StartsWith(rightPMValue, StringComparison.Ordinal);
            }
            return false;
        }
        #endregion

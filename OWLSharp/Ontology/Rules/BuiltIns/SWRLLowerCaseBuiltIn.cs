...
{
    /// <summary>
    /// SWRLLowerCaseBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#lowerCase built-in
    /// </summary>
    internal static class SWRLLowerCaseBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(OWLTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            if (isStringLeftPM && isStringRightPM)
            {
                ...
                return string.Equals(leftPMValue, rightPMValue.ToLower(), StringComparison.Ordinal);
            }
            return false;
        }
        #endregion

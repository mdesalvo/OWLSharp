...
{
    /// <summary>
    /// SWRLCeilingBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#ceiling built-in
    /// </summary>
    internal static class SWRLCeilingBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(OWLTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            {
                return leftNumber == Math.Ceiling(rightNumber);
            }

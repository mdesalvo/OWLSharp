...
{
    /// <summary>
    /// SWRLContainsBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#contains built-in
    /// </summary>
    internal static class SWRLContainsBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(OWLTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            if (isStringLeftPM && isStringRightPM)
            {
                ...
                return leftPMValue.IndexOf(rightPMValue, StringComparison.Ordinal) > -1;
            }
            return false;
        }
        #endregion

...
namespace OWLSharp.Ontology.Rules.BuiltIns
{
    ...
    {
        #region Properties
        internal static readonly RDFResource BuiltInUri = new RDFResource("swrlb:greaterThanOrEqual");
        #endregion

        #region Ctors
        public SWRLGreaterThanOrEqualBuiltIn(SWRLVariableArgument leftArgument, SWRLVariableArgument rightArgument)
            : this(leftArgument, rightArgument as SWRLArgument) { }

        public SWRLGreaterThanOrEqualBuiltIn(SWRLVariableArgument leftArgument, SWRLIndividualArgument rightArgument)
            : this(leftArgument, rightArgument as SWRLArgument) { }

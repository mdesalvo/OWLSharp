...
{
    /// <summary>
    /// SWRLSinBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#sin built-in
    /// </summary>
    internal static class SWRLSinBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(RDFTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            {
                return leftNumber == Math.Sin(rightNumber);
            }

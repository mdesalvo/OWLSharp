...
{
    /// <summary>
    /// SWRLCosBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#cos built-in
    /// </summary>
    internal static class SWRLCosBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(RDFTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            {
                return leftNumber == Math.Cos(rightNumber);
            }

...
{
    /// <summary>
    /// SWRLRoundBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#round built-in
    /// </summary>
    internal static class SWRLRoundBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(OWLTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            {
                return leftNumber == Math.Round(rightNumber);
            }

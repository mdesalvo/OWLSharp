...
{
    /// <summary>
    /// SWRLRoundHalfToEvenBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#roundHalfToEven built-in
    /// </summary>
    internal static class SWRLRoundHalfToEvenBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(OWLTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            {
                return leftNumber == Math.Round(rightNumber, MidpointRounding.ToEven);
            }

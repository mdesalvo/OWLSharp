...
{
    /// <summary>
    /// SWRLFloorBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#floor built-in
    /// </summary>
    internal static class SWRLFloorBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(OWLTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            {
                return leftNumber == Math.Floor(rightNumber);
            }

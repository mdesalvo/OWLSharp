...
{
    public class SWRLRoundBuiltIn : SWRLMathBuiltIn
    {
        #region Properties
        internal static readonly RDFResource BuiltInUri = new RDFResource("swrlb:round");
        #endregion
        ...
        #region Ctors
        internal SWRLRoundBuiltIn() { }
        public SWRLRoundBuiltIn(SWRLVariableArgument leftArgument, SWRLVariableArgument rightArgument)

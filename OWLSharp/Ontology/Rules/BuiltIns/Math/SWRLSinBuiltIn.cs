...
namespace OWLSharp.Ontology.Rules.BuiltIns
{
    ...
    {
        #region Properties
        internal static readonly RDFResource BuiltInUri = new RDFResource("swrlb:sin");
        #endregion
        ...
        #region Ctors
        internal SWRLSinBuiltIn() { }
        public SWRLSinBuiltIn(SWRLVariableArgument leftArgument, SWRLVariableArgument rightArgument)

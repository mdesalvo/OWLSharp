...
{
    public class SWRLAbsBuiltIn : SWRLMathBuiltIn
    {
        #region Properties
        internal static readonly RDFResource BuiltInUri = new RDFResource("swrlb:abs");
        #endregion
        ...
        #region Ctors
        internal SWRLAbsBuiltIn() { }
        public SWRLAbsBuiltIn(SWRLVariableArgument leftArgument, SWRLVariableArgument rightArgument)

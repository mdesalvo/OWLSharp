...
{
    /// <summary>
    /// SWRLUpperCaseBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#upperCase built-in
    /// </summary>
    internal static class SWRLUpperCaseBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(RDFTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            if (isStringLeftPM && isStringRightPM)
            {
                ...
                return string.Equals(leftPMValue, rightPMValue.ToUpper(), StringComparison.Ordinal);
            }
            return false;
        }
        #endregion

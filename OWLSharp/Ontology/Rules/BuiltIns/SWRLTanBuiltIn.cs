...
{
    /// <summary>
    /// SWRLTanBuiltIn implements the standard http://www.w3.org/2003/11/swrlb#tan built-in
    /// </summary>
    internal static class SWRLTanBuiltIn
    {
        #region Methods
        /// <summary>
        ...
        internal static bool EvaluateOnAntecedent(RDFTableRow antecedentResultsRow, List<SWRLArgument> builtInArguments)
        {
            ...
            {
                return leftNumber == Math.Tan(rightNumber);
            }

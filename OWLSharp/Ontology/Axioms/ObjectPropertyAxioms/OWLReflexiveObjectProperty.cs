...
namespace OWLSharp.Ontology
{
    ...
    public sealed class OWLReflexiveObjectProperty : OWLObjectPropertyAxiom
    {
        ...
        #region Methods
        /// <summary>
        /// Gets the contribution of this OWLReflexiveObjectProperty to the OWL2/Manchester rendering of the ontology
        /// </summary>
        internal override OWLManchesterFrameItem ToManchesterFrameItem(OWLManchesterContext manchesterContext)
            => ObjectPropertyExpression is OWLObjectProperty objProp
                ? new OWLManchesterFrameItem {
                    ...
                    ItemText = $"{manchesterContext.RenderAxiomAnnotations(Annotations)}Reflexive" }
                : null;

        /// <summary>
        /// Gets the OWL2/Functional-Style representation of this ReflexiveObjectProperty axiom
        /// </summary>
        internal override string ToFunctionalString(OWLFunctionalContext functionalContext)
            => $"ReflexiveObjectProperty( {functionalContext.RenderAxiomAnnotations(Annotations)}{ObjectPropertyExpression.ToFunctionalString(functionalContext)} )";

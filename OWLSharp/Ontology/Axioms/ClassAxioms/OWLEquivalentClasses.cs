...
namespace OWLSharp.Ontology
{
    ...
    public sealed class OWLEquivalentClasses : OWLClassAxiom
    {
        ...
        /// <summary>
        /// Gets the OWL2/Functional-Style representation of this EquivalentClasses axiom
        /// </summary>
        internal override string ToFunctionalString(OWLFunctionalContext functionalContext)
            => $"EquivalentClasses( {functionalContext.RenderAxiomAnnotations(Annotations)}{string.Join(" ", ClassExpressions.Select(clsExpr => clsExpr.ToFunctionalString(functionalContext)))} )";

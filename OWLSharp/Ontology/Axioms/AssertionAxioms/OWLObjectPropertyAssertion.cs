...
namespace OWLSharp.Ontology
{
    ...
    public sealed class OWLObjectPropertyAssertion : OWLAssertionAxiom
    {
        ...
        /// <summary>
        /// Gets the OWL2/Functional-Style representation of this ObjectPropertyAssertion axiom
        ...
        internal override string ToFunctionalString(OWLFunctionalContext functionalContext)
            => $"ObjectPropertyAssertion( {functionalContext.RenderAxiomAnnotations(Annotations)}{ObjectPropertyExpression.ToFunctionalString(functionalContext)} {SourceIndividualExpression.ToFunctionalString(functionalContext)} {TargetIndividualExpression.ToFunctionalString(functionalContext)} )";

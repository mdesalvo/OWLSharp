...
namespace OWLSharp.Ontology
{
    ...
    public sealed class OWLDataMinCardinality : OWLClassExpression
    {
        ...
        /// <summary>
        /// Gets the OWL2/Functional-Style representation of this OWLDataMinCardinality expression
        /// </summary>
        public override string ToFunctionalString(OWLFunctionalContext functionalContext)
            ...
            => $"DataMinCardinality( {Cardinality} {DataProperty.ToFunctionalString(functionalContext)}{(DataRangeExpression != null ? $" {DataRangeExpression.ToFunctionalString(functionalContext)}" : string.Empty)} )";

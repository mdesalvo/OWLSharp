...
namespace OWLSharp.Ontology
{
    ...
    public sealed class OWLObjectMaxCardinality : OWLClassExpression
    {
        ...
        /// <summary>
        /// The maximum cardinality required on the individuals targeted by the object property expression
        /// </summary>
        ...
        /// <summary>
        /// Builds an OWLObjectMaxCardinality with the given object property expression and cardinality
        /// </summary>
        /// <exception cref="OWLException"></exception>
        public OWLObjectMaxCardinality(OWLObjectPropertyExpression objectPropertyExpression, uint cardinality)
        {
            ObjectPropertyExpression = objectPropertyExpression ?? throw new OWLException($"Cannot create OWLObjectMaxCardinality because given '{nameof(objectPropertyExpression)}' parameter is null");
            Cardinality = cardinality.ToString();
        }

        /// <summary>
        /// Builds an OWLObjectMaxCardinality with the given object property expression, cardinality and qualifying class expression
        /// </summary>
        /// <exception cref="OWLException"></exception>
        public OWLObjectMaxCardinality(OWLObjectPropertyExpression objectPropertyExpression, uint cardinality, OWLClassExpression classExpression) : this(objectPropertyExpression, cardinality)
            => ClassExpression = classExpression ?? throw new OWLException($"Cannot create OWLObjectMaxCardinality because given '{nameof(classExpression)}' parameter is null");
        #endregion

        #region Methods
        /// <summary>
        /// Gets the SWRL representation of this OWLObjectMaxCardinality expression
        /// </summary>
        ...
        /// <summary>
        /// Gets the OWL2/Functional-Style representation of this OWLObjectMaxCardinality expression
        /// </summary>
        public override string ToFunctionalString(OWLFunctionalContext functionalContext)
            ...
            => $"ObjectMaxCardinality( {Cardinality} {ObjectPropertyExpression.ToFunctionalString(functionalContext)}{(ClassExpression != null ? $" {ClassExpression.ToFunctionalString(functionalContext)}" : string.Empty)} )";

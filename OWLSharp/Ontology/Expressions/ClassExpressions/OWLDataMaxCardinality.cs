...
namespace OWLSharp.Ontology
{
    ...
    public sealed class OWLDataMaxCardinality : OWLClassExpression
    {
        ...
        /// <summary>
        /// Gets the OWL2/Manchester representation of this OWLDataMaxCardinality expression
        /// </summary>
        public override string ToManchesterString(OWLManchesterContext manchesterContext)
            => $"{DataProperty.ToManchesterString(manchesterContext)} max {Cardinality}{(DataRangeExpression != null ? $" {manchesterContext.Nest(DataRangeExpression)}" : string.Empty)}";

        /// <summary>
        /// Gets the OWL2/Functional-Style representation of this OWLDataMaxCardinality expression
        /// </summary>
        public override string ToFunctionalString(OWLFunctionalContext functionalContext)
            ...
            => $"DataMaxCardinality( {Cardinality} {DataProperty.ToFunctionalString(functionalContext)}{(DataRangeExpression != null ? $" {DataRangeExpression.ToFunctionalString(functionalContext)}" : string.Empty)} )";

...
namespace OWLSharp.Ontology
{
    ...
    public sealed class OWLObjectSomeValuesFrom : OWLClassExpression
    {
        ...
        /// <summary>
        /// Builds an OWLObjectSomeValuesFrom with the given object property expression and class expression
        /// </summary>
        ...
        {
            ObjectPropertyExpression = objectPropertyExpression ?? throw new OWLException($"Cannot create OWLObjectSomeValuesFrom because given '{nameof(objectPropertyExpression)}' parameter is null");
            ClassExpression = classExpression ?? throw new OWLException($"Cannot create OWLObjectSomeValuesFrom because given '{nameof(classExpression)}' parameter is null");
        }
        #endregion

        #region Methods
        /// <summary>
        /// Gets the SWRL representation of this OWLObjectSomeValuesFrom expression
        /// </summary>
        ...
        /// <summary>
        /// Gets the OWL2/Manchester representation of this OWLObjectSomeValuesFrom expression
        /// </summary>
        public override string ToManchesterString(OWLManchesterContext manchesterContext)
            => $"{ObjectPropertyExpression.ToManchesterString(manchesterContext)} some {manchesterContext.Nest(ClassExpression)}";

        /// <summary>
        /// Gets the OWL2/Functional-Style representation of this OWLObjectSomeValuesFrom expression
        /// </summary>
        public override string ToFunctionalString(OWLFunctionalContext functionalContext)
            => $"ObjectSomeValuesFrom( {ObjectPropertyExpression.ToFunctionalString(functionalContext)} {ClassExpression.ToFunctionalString(functionalContext)} )";

        /// <summary>
        /// Exports this OWLObjectSomeValuesFrom expression to an equivalent RDFGraph object
        /// </summary>

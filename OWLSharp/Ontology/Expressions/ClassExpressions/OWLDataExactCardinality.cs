...
namespace OWLSharp.Ontology
{
    ...
    public sealed class OWLDataExactCardinality : OWLClassExpression
    {
        ...
        /// <summary>
        /// The cardinality required on the literal values assumed by the data property
        /// </summary>
        ...
        #region Ctors
        internal OWLDataExactCardinality() { }

        /// <summary>
        /// Builds an OWLDataExactCardinality with the given data property and cardinality
        /// </summary>
        /// <exception cref="OWLException"></exception>
        public OWLDataExactCardinality(OWLDataProperty dataProperty, uint cardinality)
        {
            DataProperty = dataProperty ?? throw new OWLException($"Cannot create OWLDataExactCardinality because given '{nameof(dataProperty)}' parameter is null");
            Cardinality = cardinality.ToString();
        }

        /// <summary>
        /// Builds an OWLDataExactCardinality with the given data property, cardinality and qualifying datarange expression
        /// </summary>
        /// <exception cref="OWLException"></exception>
        public OWLDataExactCardinality(OWLDataProperty dataProperty, uint cardinality, OWLDataRangeExpression datarangeExpression) : this(dataProperty, cardinality)
            => DataRangeExpression = datarangeExpression ?? throw new OWLException($"Cannot create OWLDataExactCardinality because given '{nameof(datarangeExpression)}' parameter is null");
        #endregion

        #region Methods
        /// <summary>
        /// Gets the SWRL representation of this OWLDataExactCardinality expression
        /// </summary>
        ...
        /// <summary>
        /// Gets the OWL2/Manchester representation of this OWLDataExactCardinality expression
        /// </summary>

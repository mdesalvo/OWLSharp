...
namespace OWLSharp.Ontology
{
    ...
    public static class OWLOntologyHelper
    {
        ...
        /// <summary>
        /// Imports the given RDFGraph object into an equivalent OWLOntology object
        /// </summary>
        /// <exception cref="OWLException"></exception>
        internal static Task<OWLOntology> FromRDFGraphAsync(RDFGraph graph)
            => Task.Run(() =>
                {
                    if (graph == null)
                    ...
                    void LoadOntology(out OWLOntology ont)
                    {
                        string ontIRI = typeGraph.SelectTriples(o: RDFVocabulary.OWL.ONTOLOGY)
                                                 .FirstOrDefault()?.Subject.ToString() ?? throw new OWLException("Cannot find an owl:Ontology definition in the given graph. Please ensure that it correctly encodes an OWL ontology.");
                        ont = new OWLOntology
                        {
                            IRI = ontIRI,
                    ...
                    void LoadDeclarations(OWLOntology ont)
                    {
                        ...
                        {
                            if (typeTriple.Object.Equals(RDFVocabulary.OWL.CLASS)
                                 || typeTriple.Object.Equals(RDFVocabulary.OWL.DEPRECATED_CLASS)
                                 || typeTriple.Object.Equals(RDFVocabulary.RDFS.CLASS))
                            {
                                ont.DeclarationAxioms.Add(new OWLDeclaration(((RDFResource)typeTriple.Subject).ToEntity<OWLClass>()));
                                if (typeTriple.Object.Equals(RDFVocabulary.OWL.DEPRECATED_CLASS))
                                    ont.AnnotationAxioms.Add(new OWLAnnotationAssertion(RDFVocabulary.OWL.DEPRECATED.ToEntity<OWLAnnotationProperty>(), (RDFResource)typeTriple.Subject, new OWLLiteral(RDFTypedLiteral.True)));
                                continue;
                            }

                            if (typeTriple.Object.Equals(RDFVocabulary.RDFS.DATATYPE))
                            {
                                ont.DeclarationAxioms.Add(new OWLDeclaration(((RDFResource)typeTriple.Subject).ToEntity<OWLDatatype>()));
                                continue;
                            }

                            if (typeTriple.Object.Equals(RDFVocabulary.OWL.OBJECT_PROPERTY))
                            {
                                ont.DeclarationAxioms.Add(new OWLDeclaration(((RDFResource)typeTriple.Subject).ToEntity<OWLObjectProperty>()));
                                continue;
                            }

                            if (typeTriple.Object.Equals(RDFVocabulary.OWL.DATATYPE_PROPERTY))
                            {
                                ont.DeclarationAxioms.Add(new OWLDeclaration(((RDFResource)typeTriple.Subject).ToEntity<OWLDataProperty>()));
                                continue;
                            }

                            if (typeTriple.Object.Equals(RDFVocabulary.OWL.ANNOTATION_PROPERTY))
                            {
                                ont.DeclarationAxioms.Add(new OWLDeclaration(((RDFResource)typeTriple.Subject).ToEntity<OWLAnnotationProperty>()));
                                continue;
                            }
                        ...
                        RDFSelectQuery namedIdvQuery = new RDFSelectQuery()
                            .AddPatternGroup(new RDFPatternGroup()
                                .AddBinaryPatternGroupMember(
                                    new RDFPattern(new RDFVariable("?CLS"), RDFVocabulary.RDF.TYPE, RDFVocabulary.OWL.CLASS)
                                        .Union(new RDFPattern(new RDFVariable("?CLS"), RDFVocabulary.RDF.TYPE, RDFVocabulary.OWL.RESTRICTION)))
                                .AddPattern(new RDFPattern(new RDFVariable("?NIDV"), RDFVocabulary.RDF.TYPE, new RDFVariable("?CLS")))
                                .AddFilter(new RDFFilter(new RDFNotExpression(new RDFSameTermExpression(new RDFVariable("?NIDV"), new RDFVariable("?CLS")))))
                                .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?NIDV")))))
                        ...
                        foreach (string namedIndividual in namedIndividuals.Distinct())
                            ont.DeclarationAxioms.Add(new OWLDeclaration((new RDFResource(namedIndividual)).ToEntity<OWLNamedIndividual>()));
                    }
                    ...
                    {
                        RDFPatternGroup pgOO = new RDFPatternGroup()
                            ...
                            .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?OPL"))))
                            .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?OPR"))))
                            .AddBind(new RDFBind(new RDFConstantExpression(new RDFPlainLiteral("OO")), new RDFVariable("?CASE")));
                        RDFPatternGroup pgIO = new RDFPatternGroup()
                            ...
                            .AddPattern(new RDFPattern(new RDFVariable("?OPL"), RDFVocabulary.RDF.TYPE, RDFVocabulary.OWL.OBJECT_PROPERTY))
                            .AddPattern(new RDFPattern(new RDFVariable("?OPR"), RDFVocabulary.RDF.TYPE, RDFVocabulary.OWL.OBJECT_PROPERTY))
                            .AddFilter(new RDFFilter(new RDFIsBlankExpression(new RDFVariable("?IOPL"))))
                            .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?OPL"))))
                            .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?OPR"))))
                            .AddFilter(new RDFFilter(new RDFNotExpression(new RDFSameTermExpression(new RDFVariable("?OPL"), new RDFVariable("?OPR")))))
                            .AddBind(new RDFBind(new RDFConstantExpression(new RDFPlainLiteral("IO")), new RDFVariable("?CASE")));
                        RDFPatternGroup pgOI = new RDFPatternGroup()
                            ...
                            .AddPattern(new RDFPattern(new RDFVariable("?OPL"), RDFVocabulary.RDF.TYPE, RDFVocabulary.OWL.OBJECT_PROPERTY))
                            .AddPattern(new RDFPattern(new RDFVariable("?OPR"), RDFVocabulary.RDF.TYPE, RDFVocabulary.OWL.OBJECT_PROPERTY))
                            .AddFilter(new RDFFilter(new RDFIsBlankExpression(new RDFVariable("?IOPR"))))
                            .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?OPL"))))
                            .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?OPR"))))
                            .AddFilter(new RDFFilter(new RDFNotExpression(new RDFSameTermExpression(new RDFVariable("?OPL"), new RDFVariable("?OPR")))))
                            .AddBind(new RDFBind(new RDFConstantExpression(new RDFPlainLiteral("OI")), new RDFVariable("?CASE")));
                        RDFPatternGroup pgII = new RDFPatternGroup()
                            .AddPattern(new RDFPattern(new RDFVariable("?IOPL"), RDFVocabulary.OWL.INVERSE_OF, new RDFVariable("?OPL")))
                        ...
                        RDFSelectQuery query = new RDFSelectQuery()
                            .AddBinaryQueryMember(pgOO.Union(pgIO).Union(pgOI).Union(pgII))
                        ...
                        foreach (DataRow resultRow in result.SelectResults.Rows)
                        {
                            ...
                            switch (resultRow["?CASE"].ToString())
                            {
                                case "OO":
                                    ...
                                    inverseObjectProperties.LeftObjectPropertyExpression = OPL.ToEntity<OWLObjectProperty>();
                                    inverseObjectProperties.RightObjectPropertyExpression = OPR.ToEntity<OWLObjectProperty>();
                                ...
                                case "IO":
                                    ...
                                    OPL = (RDFResource)RDFQueryUtilities.ParseRDFPatternMember(resultRow["?OPL"].ToString());
                                    OPR = (RDFResource)RDFQueryUtilities.ParseRDFPatternMember(resultRow["?OPR"].ToString());
                                    inverseObjectProperties.LeftObjectPropertyExpression = new OWLObjectInverseOf(OPL.ToEntity<OWLObjectProperty>());
                                    inverseObjectProperties.RightObjectPropertyExpression = OPR.ToEntity<OWLObjectProperty>();
                                ...
                                case "OI":
                                    ...
                                    OPR = (RDFResource)RDFQueryUtilities.ParseRDFPatternMember(resultRow["?OPR"].ToString());
                                    inverseObjectProperties.LeftObjectPropertyExpression = OPL.ToEntity<OWLObjectProperty>();
                                    inverseObjectProperties.RightObjectPropertyExpression = new OWLObjectInverseOf(OPR.ToEntity<OWLObjectProperty>());
                    ...
                    void LoadDatatypeDefinition(OWLOntology ont, RDFGraph annAxiomsGraph)
                    {
                                                               ...
                                                               .Where(t => !((RDFResource)t.Subject).IsBlank))
                        {
                            ...
                            {
                                Datatype = ((RDFResource)datatypeTriple.Subject).ToEntity<OWLDatatype>(),
                    ...
                    void LoadObjectPropertyAssertions(OWLOntology ont, RDFGraph annAxiomsGraph)
                    {
                        ...
                        OWLObjectProperty skosMember = RDFVocabulary.SKOS.MEMBER.ToEntity<OWLObjectProperty>();
                                                              ...
                                                              .Where(t => !((RDFResource)t.Subject).IsBlank))
                        {
                            ...
                            OWLObjectProperty objProp = ((RDFResource)objPropTriple.Subject).ToEntity<OWLObjectProperty>();
                    ...
                    void LoadNegativeObjectPropertyAssertions(OWLOntology ont, RDFGraph annAxiomsGraph)
                    {
                        RDFSelectQuery query = new RDFSelectQuery()
                            .AddPatternGroup(new RDFPatternGroup()
                                ...
                                .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?SIDV"))))
                                .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?OBJP"))))
                                .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?TIDV")))));
                        RDFSelectQueryResult result = query.ApplyToGraph(graph);
                        foreach (DataRow resultRow in result.SelectResults.Rows)
                        {
                            ...
                            if (leftIE != null && rightIE != null)
                            {
                                ...
                                OWLObjectProperty objProp = ((RDFResource)RDFQueryUtilities.ParseRDFPatternMember(resultRow["?OBJP"].ToString())).ToEntity<OWLObjectProperty>();
                    ...
                    void LoadDataPropertyAssertions(OWLOntology ont, RDFGraph annAxiomsGraph)
                    {
                        ...
                        {
                            OWLDataProperty dtProp = ((RDFResource)dtPropTriple.Subject).ToEntity<OWLDataProperty>();
                    ...
                    void LoadClassAssertions(OWLOntology ont, RDFGraph annAxiomsGraph)
                    {
                        RDFSelectQuery query = new RDFSelectQuery()
                            .AddPatternGroup(new RDFPatternGroup()
                                ...
                                .AddBinaryPatternGroupMember(
                                    new RDFPattern(new RDFVariable("?CLS"), RDFVocabulary.RDF.TYPE, RDFVocabulary.RDFS.CLASS)
                                        .Union(new RDFPattern(new RDFVariable("?CLS"), RDFVocabulary.RDF.TYPE, RDFVocabulary.OWL.CLASS))
                                        .Union(new RDFPattern(new RDFVariable("?CLS"), RDFVocabulary.RDF.TYPE, RDFVocabulary.OWL.DEPRECATED_CLASS))
                                        .Union(new RDFPattern(new RDFVariable("?CLS"), RDFVocabulary.RDF.TYPE, RDFVocabulary.OWL.RESTRICTION)))
                                .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?IDV"))))
                                .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?CLS"))))
                                .AddFilter(new RDFFilter(new RDFNotExpression(new RDFSameTermExpression(new RDFVariable("?IDV"), new RDFVariable("?CLS")))))
                                .AddFilter(new RDFFilter(new RDFNotExpression(new RDFInExpression(new RDFVariable("?CLS"), new List<RDFPatternMember> {
                    ...
                    void LoadNegativeDataPropertyAssertions(OWLOntology ont, RDFGraph annAxiomsGraph)
                    {
                        RDFSelectQuery query = new RDFSelectQuery()
                            .AddPatternGroup(new RDFPatternGroup()
                                ...
                                .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?SIDV"))))
                                .AddFilter(new RDFFilter(new RDFIsUriExpression(new RDFVariable("?DTP"))))
                                .AddFilter(new RDFFilter(new RDFIsLiteralExpression(new RDFVariable("?TVAL")))));
                        RDFSelectQueryResult result = query.ApplyToGraph(graph);
                        foreach (DataRow resultRow in result.SelectResults.Rows)
                        {
                            LoadIndividualExpression(ont, (RDFResource)RDFQueryUtilities.ParseRDFPatternMember(resultRow["?SIDV"].ToString()), out OWLIndividualExpression leftIE);
                            ...
                            {
                                RDFResource axiomIRI = (RDFResource)RDFQueryUtilities.ParseRDFPatternMember(resultRow["?NASN"].ToString());
                                OWLDataProperty dtProp = ((RDFResource)RDFQueryUtilities.ParseRDFPatternMember(resultRow["?DTP"].ToString())).ToEntity<OWLDataProperty>();
                    ...
                    void LoadAxiomAnnotations(OWLOntology ont, RDFTriple axiomTriple, OWLAxiom axiom, RDFGraph annAxiomsGraph)
                    {
                        ...
                        foreach (DataRow resultRow in result.SelectResults.Rows)
                        {
                            ...
                            OWLAnnotation annotation = annVal is RDFResource annValRes2
                                ? new OWLAnnotation(((RDFResource)annProp).ToEntity<OWLAnnotationProperty>(), annValRes2)
                                : new OWLAnnotation(((RDFResource)annProp).ToEntity<OWLAnnotationProperty>(), new OWLLiteral((RDFLiteral)annVal));
                    ...
                    void LoadIRIAnnotations(OWLOntology ont, List<RDFResource> annotationProperties, RDFResource iri, RDFGraph annAxiomsGraph, out List<OWLAnnotation> annotations)
                    {
                        ...
                        {
                            OWLAnnotationProperty annotationProperty = workingAnnotationProperty.ToEntity<OWLAnnotationProperty>();
                    ...
                    {
                        OWLAnnotationProperty label = RDFVocabulary.RDFS.LABEL.ToEntity<OWLAnnotationProperty>();
                        OWLAnnotationProperty comment = RDFVocabulary.RDFS.COMMENT.ToEntity<OWLAnnotationProperty>();
                            ...
                            foreach (RDFTriple ruleLabel in ruleGraph.SelectTriples(p: RDFVocabulary.RDFS.LABEL))
                            {
                                switch (ruleLabel.Object)
                                {
                                    case RDFLiteral ruleLabelLit:
                                        rule.Annotations.Add(new OWLAnnotation(label, new OWLLiteral(ruleLabelLit)));
                                        break;
                                    case RDFResource ruleLabelRes:
                                        rule.Annotations.Add(new OWLAnnotation(label, ruleLabelRes));
                                        break;
                                }
                            }
                            foreach (RDFTriple ruleComment in ruleGraph.SelectTriples(p: RDFVocabulary.RDFS.COMMENT))
                            {
                                switch (ruleComment.Object)
                                {
                                    case RDFLiteral ruleCommentLit:
                                        rule.Annotations.Add(new OWLAnnotation(comment, new OWLLiteral(ruleCommentLit)));
                                        break;
                                    case RDFResource ruleCommentRes:
                                        rule.Annotations.Add(new OWLAnnotation(comment, ruleCommentRes));
                                        break;
                                }
                            }
                                    ...
                                    foreach (RDFTriple ruleCustomAnnotation in ruleGraph.SelectTriples(p: annPropIRI))
                                        switch (ruleCustomAnnotation.Object)
                                        {
                                            case RDFLiteral ruleCustomAnnotationLit:
                                                rule.Annotations.Add(new OWLAnnotation(annPropIRI.ToEntity<OWLAnnotationProperty>(), new OWLLiteral(ruleCustomAnnotationLit)));
                                                break;
                                            case RDFResource ruleCustomAnnotationRes:
                                                rule.Annotations.Add(new OWLAnnotation(annPropIRI.ToEntity<OWLAnnotationProperty>(), ruleCustomAnnotationRes));
                                                break;
                                        }
                                }
                            }
                                 ...
                                 && typeGraph.SelectTriples(s: ruleAntecedent, o: RDFVocabulary.SWRL.ATOMLIST).Count == 1)
                            {
                                ...
                                if (antecedentItems.ItemsCount > 0)
                                {
                                    ...
                                    antecedentItems.Items.ForEach(antecedentItem =>
                                    {
                                        ...
                                        else if (TryLoadAnnotationPropertyAtom(ont, antecedentItem, out SWRLAnnotationPropertyAtom annotationpropertyAtom))
                                            antecedent.Atoms.Add(annotationpropertyAtom);
                                    });
                                 ...
                                 && typeGraph.SelectTriples(s: ruleConsequent, o: RDFVocabulary.SWRL.ATOMLIST).Count == 1)
                            {
                                ...
                                if (consequentItems.ItemsCount > 0)
                                {
                                    ...
                                    consequentItems.Items.ForEach(consequentItem =>
                                    {
                                        ...
                                        //AnnotationPropertyAtom
                                        else if (TryLoadAnnotationPropertyAtom(ont, consequentItem, out SWRLAnnotationPropertyAtom annotationpropertyAtom))
                                            consequent.Atoms.Add(annotationpropertyAtom);
                                    });
                    ...
                    bool TryLoadAnnotationPropertyAtom(OWLOntology ont, RDFPatternMember antecedentItem, out SWRLAnnotationPropertyAtom annotationpropertyAtom)
                    {
                             ...
                             && graph.SelectTriples(s: antecedentItemResource, p: RDFVocabulary.SWRL.ARGUMENT2).FirstOrDefault()?.Object is RDFPatternMember arg2)
                        {
                            ...
                            if (annpropExp != null)
                            {
                                annotationpropertyAtom = new SWRLAnnotationPropertyAtom { Predicate = annpropExp };

                                //Argument1
                                string arg1Str = arg1.ToString();
                                if (arg1Str.StartsWith("urn:swrl:var#", StringComparison.OrdinalIgnoreCase))
                                    annotationpropertyAtom.LeftArgument = new SWRLVariableArgument(new RDFVariable($"?{arg1Str.Replace("urn:swrl:var#", string.Empty)}"));
                                else
                                    annotationpropertyAtom.LeftArgument = new SWRLIndividualArgument(arg1);

                                //Argument2
                                switch (arg2)
                                {
                                    case RDFLiteral arg2Lit:
                                        annotationpropertyAtom.RightArgument = new SWRLLiteralArgument(arg2Lit);
                                        return true;
                                    case RDFResource arg2Res:
                                        {
                                            string arg2Str = arg2Res.ToString();
                                            if (arg2Str.StartsWith("urn:swrl:var#", StringComparison.OrdinalIgnoreCase))
                                            {
                                                annotationpropertyAtom.RightArgument = new SWRLVariableArgument(new RDFVariable($"?{arg2Str.Replace("urn:swrl:var#", string.Empty)}"));
                                                return true;
                                            }
                                            break;
                                        }
                    ...
                    void LoadAnnotationPropertyExpression(OWLOntology ont, RDFResource apIRI, out OWLAnnotationPropertyExpression apex)
                    {
                        ...
                        if (typeGraph.SelectTriples(s: apIRI, o: RDFVocabulary.OWL.ANNOTATION_PROPERTY).Count > 0)
                            apex = apIRI.ToEntity<OWLAnnotationProperty>();
                    }
                    void LoadObjectPropertyExpression(OWLOntology ont, RDFResource opIRI, out OWLObjectPropertyExpression opex)
                    {
                        ...
                        if (graph.SelectTriples(s: opIRI, p: RDFVocabulary.OWL.INVERSE_OF).FirstOrDefault()?.Object is RDFResource objectProperty)
                            opex = new OWLObjectInverseOf(objectProperty.ToEntity<OWLObjectProperty>());
                        else if (typeGraph.SelectTriples(s: opIRI, o: RDFVocabulary.OWL.OBJECT_PROPERTY).Count > 0)
                            opex = opIRI.ToEntity<OWLObjectProperty>();
                    }
                    void LoadDataPropertyExpression(OWLOntology ont, RDFResource dpIRI, out OWLDataPropertyExpression dpex)
                    {
                        ...
                        if (typeGraph.SelectTriples(s: dpIRI, o: RDFVocabulary.OWL.DATATYPE_PROPERTY).Count > 0)
                            dpex = dpIRI.ToEntity<OWLDataProperty>();
                    }
                    void LoadIndividualExpression(OWLOntology ont, RDFResource idvIRI, out OWLIndividualExpression idvex)
                    {
                        ...
                        if (idvIRI.IsBlank)
                            ...
                            idvex = idvIRI.ToEntity<OWLNamedIndividual>();
                    }
                    void LoadClassExpression(OWLOntology ont, RDFResource clsIRI, out OWLClassExpression clex)
                    {
                        ...
                        if (clsGraph.SelectTriples(p: RDFVocabulary.RDF.TYPE, o: RDFVocabulary.OWL.CLASS).Count > 0
                            ...
                            || clsGraph.SelectTriples(p: RDFVocabulary.RDF.TYPE, o: RDFVocabulary.OWL.DEPRECATED_CLASS).Count > 0)
                        {
                            //COMPOSITE
                    ...
                    void LoadDataRangeExpression(OWLOntology ont, RDFResource drIRI, out OWLDataRangeExpression drex)
                    {
                        ...
                        if (drGraph.SelectTriples(p: RDFVocabulary.RDF.TYPE, o: RDFVocabulary.RDFS.DATATYPE).Count > 0)
                        {
                            ...
                            {
                                drex = new OWLDatatypeRestriction(equivalentDatatype.ToEntity<OWLDatatype>(), null);
                                return;
                            }
                            #endregion

                            #region Datatype
                            drex = drIRI.ToEntity<OWLDatatype>();
                            #endregion
                        }
                        #endregion
                    }
                    ...
                    void LoadDatatypeRestriction(OWLOntology ont, RDFResource drIRI, RDFResource onDatatype, RDFResource withRestrictions, out OWLDatatypeRestriction dtRST)
                    {
                        ...
                        dtRST = new OWLDatatypeRestriction(onDatatype.ToEntity<OWLDatatype>(), facetRestrictions);
                    }
                    #endregion

...
namespace OWLSharp
{
    ...
    public class OWLOntologyLoaderOptions
    {
        ...
        /// <summary>
        /// Tells the ontology loader to explicitly inject GeoSPARQL knowledge during the loading process<br/>
        /// [Default: False]
        /// </summary>
        public bool EnableGEOSupport { get; set; } = false;

        /// <summary>
        /// Tells the ontology loader to explicitly inject OWL-TIME knowledge during the loading process<br/>
        /// [Default: False]
        /// </summary>
        public bool EnableTIMESupport { get; set; } = false;

        /// <summary>
        /// Tells the ontology loader to explicitly inject SKOS knowledge during the loading process<br/>
        /// [Default: False]
        /// </summary>

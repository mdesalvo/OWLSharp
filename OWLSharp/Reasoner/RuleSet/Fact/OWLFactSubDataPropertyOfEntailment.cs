...
{
    internal static class OWLFactSubDataPropertyOfEntailment
    {
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.FactSubDataPropertyOfEntailment);
        ...
        internal static List<OWLInference> ExecuteRule(OWLOntology ontology)
        {
            ...
            if (sdpofAxms.Count > 0)
            {
                                                                         ...
                                                                         .Select(ax => (OWLDataProperty)ax.Entity))
                {
                    ...
                    if (superDataProperties.Count == 0)
                        continue;

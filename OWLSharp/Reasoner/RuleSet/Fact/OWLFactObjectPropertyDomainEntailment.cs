...
{
    internal static class OWLFactObjectPropertyDomainEntailment
    {
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.FactObjectPropertyDomainEntailment);

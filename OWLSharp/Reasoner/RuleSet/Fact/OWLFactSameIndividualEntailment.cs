...
{
    internal static class OWLFactSameIndividualEntailment
    {
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.FactSameIndividualEntailment);

...
{
    internal static class OWLFactDifferentIndividualsEntailment
    {
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.FactDifferentIndividualsEntailment);

        internal static List<OWLInference> ExecuteRule(OWLOntology ontology)
        {
            List<OWLInference> inferences = new List<OWLInference>();

            if (ontology.AssertionAxioms.Any(asnAxm => asnAxm is OWLDifferentIndividuals))
            {

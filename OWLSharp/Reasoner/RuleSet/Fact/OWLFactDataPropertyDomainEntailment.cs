...
{
    internal static class OWLFactDataPropertyDomainEntailment
    {
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.FactDataPropertyDomainEntailment);

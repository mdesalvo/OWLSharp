...
{
    internal static class OWLFactInverseFunctionalObjectPropertyEntailment
    {
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.FactInverseFunctionalObjectPropertyEntailment);

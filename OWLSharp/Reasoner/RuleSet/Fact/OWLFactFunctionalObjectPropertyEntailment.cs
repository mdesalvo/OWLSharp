...
{
    internal static class OWLFactFunctionalObjectPropertyEntailment
    {
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.FactFunctionalObjectPropertyEntailment);

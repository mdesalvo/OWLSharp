...
{
    internal static class OWLFactTransitiveObjectPropertyEntailment
    {
        private static readonly List<OWLIndividualExpression> EmptyIdvExprList = Enumerable.Empty<OWLIndividualExpression>().ToList();
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.FactTransitiveObjectPropertyEntailment);

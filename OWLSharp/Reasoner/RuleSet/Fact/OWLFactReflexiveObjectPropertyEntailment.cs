...
{
    internal static class OWLFactReflexiveObjectPropertyEntailment
    {
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.FactReflexiveObjectPropertyEntailment);

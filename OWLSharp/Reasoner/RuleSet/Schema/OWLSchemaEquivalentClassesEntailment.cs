...
{
    internal static class OWLSchemaEquivalentClassesEntailment
    {
        internal static readonly string rulename = nameof(OWLEnums.OWLReasonerRules.SchemaEquivalentClassesEntailment);

        internal static List<OWLInference> ExecuteRule(OWLOntology ontology)
        {
            List<OWLInference> inferences = new List<OWLInference>();

            //Cheap short-circuit: skip the O(declaredClasses) scan below entirely when the T-Box has no EquivalentClasses axiom at all

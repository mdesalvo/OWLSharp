...
{
    /// <summary>
    /// OWLReasonerRuleAbsBuiltIn represents a SWRL built-in filtering inferences of a rule's antecedent on a swrlb:abs basis
    /// </summary>
    public class OWLReasonerRuleAbsBuiltIn : OWLReasonerRuleMathBuiltIn
    {
        #region Properties
        /// <summary>
        /// Represents the Uri of the built-in (swrlb:abs)
        /// </summary>
        private static readonly RDFResource BuiltInUri = new RDFResource("swrlb:abs");
        #endregion

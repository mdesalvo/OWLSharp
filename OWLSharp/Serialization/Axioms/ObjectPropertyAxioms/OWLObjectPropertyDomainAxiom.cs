...
namespace OWLSharp
{
    public class OWLObjectPropertyDomainAxiom : OWLObjectPropertyAxiom
    {
        #region Properties
        ...
        #region Ctors
        internal OWLObjectPropertyDomainAxiom() : base() { }
        public OWLObjectPropertyDomainAxiom(OWLObjectPropertyExpression objectPropertyExpression, OWLClassExpression classExpression) : this()
        {
            ObjectPropertyExpression = objectPropertyExpression ?? throw new OWLException("Cannot create OWLObjectPropertyDomainAxiom because given \"objectPropertyExpression\" parameter is null");
            ClassExpression = classExpression ?? throw new OWLException("Cannot create OWLObjectPropertyDomainAxiom because given \"classExpression\" parameter is null");
        }
        #endregion
    }
}
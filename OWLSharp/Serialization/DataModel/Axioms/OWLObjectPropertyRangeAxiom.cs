...
namespace OWLSharp
{
    public class OWLObjectPropertyRangeAxiom : OWLObjectPropertyAxiom
    {
        #region Properties
        ...
        #region Ctors
        internal OWLObjectPropertyRangeAxiom() : base() { }
        public OWLObjectPropertyRangeAxiom(OWLObjectPropertyExpression objectPropertyExpression, OWLClassExpression classExpression) : this()
        {
            ObjectPropertyExpression = objectPropertyExpression ?? throw new OWLException("Cannot create OWLObjectPropertyRangeAxiom because given \"objectPropertyExpression\" parameter is null");
            ClassExpression = classExpression ?? throw new OWLException("Cannot create OWLObjectPropertyRangeAxiom because given \"classExpression\" parameter is null");
        }
        #endregion
    }
}
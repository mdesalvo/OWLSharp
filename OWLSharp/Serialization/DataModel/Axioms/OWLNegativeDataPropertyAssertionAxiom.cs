...
namespace OWLSharp
{
    public class OWLNegativeDataPropertyAssertionAxiom : OWLAssertionAxiom
    {
        ...
        public OWLNegativeDataPropertyAssertionAxiom(OWLDataProperty dataProperty, OWLIndividualExpression sourceIndividualExpression, OWLLiteral targetLiteral) : this()
        {
            DataProperty = dataProperty ?? throw new OWLException("Cannot create OWLNegativeDataPropertyAssertionAxiom because given \"dataProperty\" parameter is null");
            ...
            TargetLiteral = targetLiteral ?? throw new OWLException("Cannot create OWLNegativeDataPropertyAssertionAxiom because given \"targetLiteral\" parameter is null");
        }
        #endregion
    }
}
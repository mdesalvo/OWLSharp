...
namespace OWLSharp
{
    ...
    public partial class OWLDatatypeDefinitionAxiom : OWLAxiom
    {
        ...
        #region Ctors
        public OWLDatatypeDefinitionAxiom(OWLDatatype datatypeIRI, OWLDataRangeExpression dataRangeExpression) : this()
        {
            Datatype = datatypeIRI ?? throw new OWLException("Cannot create OWLDatatypeDefinitionAxiom because given \"datatypeIRI\" parameter is null");
            DataRangeExpression = dataRangeExpression ?? throw new OWLException("Cannot create OWLDatatypeDefinitionAxiom because given \"dataRangeExpression\" parameter is null");
        }
        #endregion
    }
}